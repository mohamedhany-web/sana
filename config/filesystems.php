...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | مرفقات نموذج طلب المعلم (فيديو، CV، شهادات…)
    |--------------------------------------------------------------------------
    | الافتراضي r2 — يُخزَّن على Cloudflare R2. للتطوير المحلي فقط: TUTOR_APPLICATION_DISK=public
    */
    'tutor_application_disk' => env('TUTOR_APPLICATION_DISK', 'r2'),
