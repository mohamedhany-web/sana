...
<style>
    ...
    .sd-btn-outline {
        ...
        border-radius: 13px;
        border: 2px solid rgba({{ $b['blue_rgb'] }}, 0.25);
        color: var(--sd-blue);
        font-size: 0.8125rem;
        font-weight: 700;
        background: #fff;
    ...
    .sd-btn-primary.w-full,
    .sd-btn-outline.w-full {
        width: 100%;
        justify-content: center;
    }
    ...
    .sd-badge-live { background: #dbeafe; color: #1e40af; }
    .sd-badge-done { background: #ede9fe; color: #5b21b6; }
    .sd-badge-off { background: #fee2e2; color: #991b1b; }
    .sd-detail-row {
        display: flex;
    ...
    .sd-detail-row > span { color: #64748b; font-weight: 600; flex-shrink: 0; }
    .sd-detail-row > strong { color: #0f172a; text-align: start; font-weight: 800; }
    .sd-alert-info {
        background: #eff6ff;
    ...
    .sd-chip:has(input:checked) {
        ...
        background: rgba({{ $b['blue_rgb'] }}, 0.08);
        color: var(--sd-blue);
        font-weight: 700;
    }
    ...
    .sd-teacher-card {
        ...
        overflow: hidden;
        transition: transform .2s, box-shadow .2s, border-color .2s;
        box-shadow: 0 10px 32px -22px rgba({{ $b['blue_rgb'] }}, 0.15);
    }
    .sd-teacher-card:hover {
        transform: translateY(-4px);
        border-color: rgba({{ $b['purple_rgb'] }}, 0.28);
        box-shadow: 0 20px 48px -20px rgba({{ $b['purple_rgb'] }}, 0.22);
    }
    .sd-teacher-card__head {
        padding: 1.15rem 1.2rem 1rem;
        background: linear-gradient(180deg, rgba({{ $b['blue_rgb'] }}, 0.04) 0%, #fff 100%);
        border-bottom: 1px solid #f1f5f9;
    }
    ...
    .sd-teacher-card__avatar {
        ...
        font-weight: 800;
        font-size: 1.15rem;
        box-shadow: 0 8px 20px -10px rgba({{ $b['purple_rgb'] }}, 0.45);
    }
