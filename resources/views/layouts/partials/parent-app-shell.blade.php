{{-- أنماط لوحة ولي الأمر — نفس هيكل الطالب --}}
@once
<script>
(function () {
...
<style>
    .app-shell-parent {
        --stu-primary: {{ config('parent.colors.primary_dark') }};
        --stu-accent: {{ config('parent.colors.accent') }};
        --stu-rose: {{ config('parent.colors.soft') }};
    }
    ...
    .app-shell-parent .ins-nav::before {
        ...
        background: linear-gradient(180deg, {{ config('parent.colors.primary') }}, {{ config('parent.colors.accent') }}) !important;
    }
    ...
    .app-shell-parent .stu-user-chip .u-avatar {
        ...
        height: 2.25rem;
        border-radius: 10px;
        background: linear-gradient(135deg, {{ config('parent.colors.primary') }}, {{ config('parent.colors.accent') }});
    }
