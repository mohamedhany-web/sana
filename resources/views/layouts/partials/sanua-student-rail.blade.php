...
@php
    ...
    $candidates = [
        ...
        ['route' => 'student.tutor-lessons.hub', 'match' => [
            'student.tutor-lessons.hub',
            'student.tutor-lessons.profile',
            'student.tutor-lessons.profile.update',
            'student.tutor-lessons.schedule',
            'student.tutor-lessons.schedule.store',
            'student.tutor-lessons.teachers',
            'student.tutor-lessons.book',
            'student.tutor-lessons.book.store',
            'student.tutor-lessons.bookings.*',
            'student.tutor-lessons.assisted',
            'student.tutor-lessons.assisted.store',
            'student.tutor-lessons.assisted.show',
        ], 'icon' => 'fa-chalkboard-user', 'label' => 'دروس', 'show' => Route::has('student.tutor-lessons.hub')],
        ['route' => 'student.tutor-lessons.hours', 'match' => ['student.tutor-lessons.hours', 'student.tutor-lessons.hours.*'], 'icon' => 'fa-clock', 'label' => 'ساعات', 'show' => Route::has('student.tutor-lessons.hours')],
        ['route' => 'my-courses.index', 'match' => ['my-courses.*'], 'icon' => 'fa-book-open', 'label' => 'كورساتي', 'show' => config('student.courses_enabled') && ($isStudent || $user->hasPermission('student.view.my-courses'))],
        ['route' => 'public.courses', 'match' => ['public.courses', 'public.course.*', 'courses.show', 'academic-years*', 'subjects.*'], 'icon' => 'fa-compass', 'label' => 'استكشف', 'show' => config('student.courses_enabled') && ($isStudent || $user->hasPermission('student.view.courses'))],
