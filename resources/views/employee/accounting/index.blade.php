                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($payment->status === 'paid' && $payment->transfer_receipt_path)
                                <a href="{{ public_storage_url($payment->transfer_receipt_path) }}" target="_blank" class="inline-flex items-center gap-1 text-sm text-blue-600 hover:text-blue-800 font-medium"><i class="fas fa-receipt"></i> تحميل الإيصال</a>
                            @else
