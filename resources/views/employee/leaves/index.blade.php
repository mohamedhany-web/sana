...
@section('title', __('طلبات الإجازة'))
@section('header', __('طلبات الإجازة'))
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="flex items-end gap-2">
                ...
                @if(request()->hasAny(['status', 'type']))
                    <a href="{{ route('employee.leaves.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $leave->type_label }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('employee.leaves.show', $leave) }}" class="text-blue-600 hover:text-blue-900">
