...
@section('title', __('إنشاء برنامج إحالة'))
@section('header', '')
            ...
            <form action="{{ route('admin.referral-programs.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-300 bg-white text-gray-900 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all">{{ old('description') }}</textarea>
                </div>
