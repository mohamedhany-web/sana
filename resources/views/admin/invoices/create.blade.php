...
@section('title', __('إنشاء فاتورة جديدة'))
@section('header', __('إنشاء فاتورة جديدة'))
        ...
        <form action="{{ route('admin.invoices.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="search" id="invoice-client-search" autocomplete="off" placeholder="{{ __('بحث بالاسم أو البريد أو الجوال…') }}"
