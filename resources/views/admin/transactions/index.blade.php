...
@section('header', __('إدارة المعاملات المالية'))
        ...
        <div class="p-4">
            <form method="GET" action="{{ route('admin.transactions.index') }}" id="filterForm" class="flex flex-col gap-3 sm:flex-row sm:items-end sm:flex-wrap">
                <div class="flex-1 min-w-[180px]">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" maxlength="255" placeholder="{{ __('رقم المعاملة، اسم العميل، هاتف') }}" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('admin.transactions.index') }}" class="inline-flex items-center justify-center rounded-xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50" title="{{ __('مسح الفلتر') }}">
                        ...
                        <div class="px-3 py-2.5">
                            <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                ...
                                <div class="flex items-center gap-1.5 flex-shrink-0">
                                    <a href="{{ route('admin.transactions.show', $transaction) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-300 bg-white text-blue-600 hover:bg-blue-50 text-sm" title="{{ __('عرض') }}">
