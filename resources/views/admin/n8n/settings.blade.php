    ...
    <div class="space-y-6">
        ...
        <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
            ...
            <div class="px-6 py-5">
                ...
                <form method="POST" action="{{ route('admin.n8n.settings.test-connection') }}" class="mt-4 pt-4 border-t border-slate-200 max-w-xl"
        ...
        <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
            ...
            <div class="px-6 py-5 space-y-4 text-sm text-slate-700">
                ...
                <div class="rounded-xl bg-slate-50 border border-dashed border-slate-200 px-4 py-3">
                    ...
                    <pre class="text-xs font-mono text-slate-700 whitespace-pre-wrap break-all">@json($examplePayload, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE)</pre>
                    <p class="mt-2 text-[11px] text-slate-500">
                        الحقول الأساسية:
