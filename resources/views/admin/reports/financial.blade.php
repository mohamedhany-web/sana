...
@section('header', __('التقارير المالية'))
...
<div class="space-y-6">
    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-6 py-5 bg-slate-50 border-b border-slate-200 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-black text-slate-900">{{ __('التقارير المالية') }}</h2>
                    <p class="text-sm text-slate-600 mt-1">{{ __('تقارير شاملة عن الفواتير، المدفوعات، المعاملات، والمصروفات') }}</p>
                </div>
            </div>
    ...
    <section class="rounded-xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        ...
        <div class="p-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-700 mb-2">{{ __('النوع') }}</label>
                    <select name="type" class="w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm text-slate-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                        <option value="all" {{ $type == 'all' ? 'selected' : '' }}>{{ __('الكل') }}</option>
                        <option value="summary" {{ $type == 'summary' ? 'selected' : '' }}>{{ __('الملخص') }}</option>
                        <option value="invoices" {{ $type == 'invoices' ? 'selected' : '' }}>{{ __('الفواتير فقط') }}</option>
                        <option value="payments" {{ $type == 'payments' ? 'selected' : '' }}>{{ __('المدفوعات فقط') }}</option>
                        <option value="transactions" {{ $type == 'transactions' ? 'selected' : '' }}>{{ __('المعاملات فقط') }}</option>
                        <option value="expenses" {{ $type == 'expenses' ? 'selected' : '' }}>{{ __('المصروفات فقط') }}</option>
                    </select>
                </div>
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    <p class="text-xs font-semibold text-slate-600">{{ __('إجمالي الإيرادات') }}</p>
        ...
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    <p class="text-xs font-semibold text-slate-600">{{ __('إجمالي المصروفات') }}</p>
        ...
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    <p class="text-xs font-semibold text-slate-600">{{ __('الربح الصافي') }}</p>
        ...
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    <p class="text-xs font-semibold text-slate-600">{{ __('عدد الفواتير') }}</p>
    ...
    <section class="rounded-xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
            ...
            <span class="text-xs font-semibold text-slate-600">{{ $invoices->total() }} {{ __('فاتورة') }}</span>
        </div>
        <div class="p-6">
            @if($invoices->count() > 0)
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('رقم الفاتورة') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('المستخدم') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('المبلغ') }}</th>
                        ...
                        <tbody class="bg-white divide-y divide-slate-200">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700">{{ htmlspecialchars($invoice->user->name ?? __('غير محدد'), ENT_QUOTES, 'UTF-8') }}</td>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-xs text-slate-600">{{ __('لا توجد فواتير مطابقة للبحث الحالي.') }}</p>
                </div>
            @endif
        </div>
    </section>
    ...
    <section class="rounded-xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
            ...
            <span class="text-xs font-semibold text-slate-600">{{ $payments->total() }} {{ __('دفع') }}</span>
        </div>
        <div class="p-6">
            @if($payments->count() > 0)
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('المستخدم') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('المبلغ') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('طريقة الدفع') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('الحالة') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('تاريخ الدفع') }}</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-slate-200">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700">{{ htmlspecialchars($payment->user->name ?? __('غير محدد'), ENT_QUOTES, 'UTF-8') }}</td>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-sm font-bold text-slate-900 mb-1">{{ __('لا توجد بيانات') }}</p>
                    <p class="text-xs text-slate-600">{{ __('لا توجد مدفوعات مطابقة للبحث الحالي.') }}</p>
                </div>
            @endif
        </div>
    </section>
    ...
    <section class="rounded-xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
            ...
            <span class="text-xs font-semibold text-slate-600">{{ $transactions->total() }} {{ __('معاملة') }}</span>
        </div>
        <div class="p-6">
                    ...
                    <table class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">ID</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('المستخدم') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('النوع') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('المبلغ') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('الحالة') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('التاريخ') }}</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-slate-200">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700">{{ htmlspecialchars($transaction->user->name ?? __('غير محدد'), ENT_QUOTES, 'UTF-8') }}</td>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-sm font-bold text-slate-900 mb-1">{{ __('لا توجد بيانات') }}</p>
                    <p class="text-xs text-slate-600">{{ __('لا توجد معاملات مطابقة للبحث الحالي.') }}</p>
                </div>
            @endif
        </div>
    </section>
    ...
    <section class="rounded-xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
            ...
            <span class="text-xs font-semibold text-slate-600">{{ $expenses->total() }} {{ __('مصروف') }}</span>
        </div>
        <div class="p-6">
            @if($expenses->count() > 0)
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('رقم المصروف') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('العنوان') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('الفئة') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('المبلغ') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('الحالة') }}</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-700 uppercase tracking-wider">{{ __('تاريخ المصروف') }}</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-slate-200">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-sm font-bold text-slate-900 mb-1">{{ __('لا توجد بيانات') }}</p>
                    <p class="text-xs text-slate-600">{{ __('لا توجد مصروفات مطابقة للبحث الحالي.') }}</p>
                </div>
            @endif
        </div>
    </section>
