...
@section('title', __('إضافة اشتراك'))
@section('header', __('إضافة اشتراك'))
        ...
        <form action="{{ route('admin.subscriptions.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="mx-user-search" placeholder="{{ __('ابحث بالاسم أو الهاتف...') }}" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg mb-2">
