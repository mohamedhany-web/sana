...
<div class="space-y-6">
    ...
    <form method="POST" action="{{ route('admin.live-servers.store') }}" class="bg-white rounded-xl border border-slate-200 p-6 space-y-5">
        @csrf
        <div class="grid md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input type="text" name="domain" value="{{ old('domain') }}" required class="w-full rounded-lg border-slate-300" placeholder="live.Sana.com">
            ...
            <div>
                ...
                <input type="text" name="ip_address" value="{{ old('ip_address') }}" class="w-full rounded-lg border-slate-300" placeholder="xxx.xxx.xxx.xxx">
            </div>
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-1">الحد الأقصى للمشاركين <span class="text-red-500">*</span></label>
                <input type="number" name="max_participants" value="{{ old('max_participants', 100) }}" min="2" max="10000" required class="w-full rounded-lg border-slate-300">
            </div>
            <div class="md:col-span-2">
            ...
            <div class="md:col-span-2 border-t border-slate-200 pt-5 mt-2">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="ssh_port" value="{{ old('ssh_port', 22) }}" min="1" max="65535" class="w-full rounded-lg border-slate-300">
                    </div>
                    <div>
