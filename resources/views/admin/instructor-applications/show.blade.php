...
<div class="space-y-6 sm:space-y-8">
            ...
            <div class="space-y-4">
                ...
                <dl class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between gap-4 border-b border-slate-100 pb-2">
                        ...
                        <dd class="font-medium {{ $user?->is_active ? 'text-emerald-700' : 'text-amber-700' }}">
                            {{ $user?->is_active ? 'نعم' : 'لا (بانتظار القبول)' }}
                        </dd>
                    </div>
                    <div class="flex justify-between gap-4 border-b border-slate-100 pb-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <section class="rounded-3xl bg-white/95 border border-emerald-200 shadow-lg p-6 sm:p-8">
            ...
            <form method="POST" action="{{ route('admin.instructor-applications.approve', $application) }}" class="space-y-4">
                @csrf
                <div>
        ...
        <section class="rounded-3xl bg-white/95 border border-rose-200 shadow-lg p-6 sm:p-8">
            ...
            <form method="POST" action="{{ route('admin.instructor-applications.reject', $application) }}" class="space-y-4">
                @csrf
                <div>
