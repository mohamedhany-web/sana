<div class="flex flex-col h-full">
    ...
    <div class="px-4 py-5 flex-shrink-0 sidebar-logo-head border-b">
        ...
        ?>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-logo flex items-center gap-3 no-underline">
            <?php if(! empty($sidebarLogoUrl)): ?>
            <div class="sidebar-brand-icon flex items-center justify-center flex-shrink-0 overflow-hidden" title="<?php echo e($platformName ?? config('brand.name', config('app.name'))); ?>">
                <img src="<?php echo e($sidebarLogoUrl); ?>" alt="<?php echo e($platformName ?? config('brand.name', config('app.name'))); ?>" width="40" height="40" class="sidebar-brand-icon__img">
            </div>
            <?php else: ?>
            <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg" style="background: linear-gradient(135deg, var(--admin-primary), var(--admin-purple));">
                <span class="text-lg font-black text-white"><?php echo e($platformInitial ?? mb_substr(config('brand.name', config('app.name')), 0, 1)); ?></span>
            </div>
            <?php endif; ?>
            <div class="sidebar-logo-text">
                <h2 class="text-sm font-heading font-bold tracking-tight leading-tight"><?php echo e($platformName ?? config('brand.name', config('app.name'))); ?></h2>
                <p class="text-[9px] text-slate-500 font-medium"><?php echo e(__('admin.admin_panel')); ?></p>
            </div>
        </a>
    </div>
    ...
    <nav class="flex-1 px-3 py-4 overflow-y-auto sidebar-nav" style="min-height: 0;">
        <ul class="space-y-0.5">
            ...
            ?>
            <?php if($canInstructorApplications && Route::has('admin.instructor-applications.index')): ?>
            <li>
                <a href="<?php echo e(route('admin.instructor-applications.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.instructor-applications.*') ? 'active' : ''); ?>">
                    <i class="fas fa-user-plus"></i>
                    <span>انضمام المعلمين</span>
                    <?php if($pendingInstructorApplications > 0): ?>
                        <span class="sidebar-badge bg-amber-500 text-white"><?php echo e($pendingInstructorApplications > 99 ? '99+' : $pendingInstructorApplications); ?></span>
                    <?php endif; ?>
                </a>
            </li>
            <?php endif; ?>
            ...
            <?php $sidebarContactUnread = (int) ($sb['sidebar_contact_unread'] ?? 0); ?>
            <li>
            ...
            <li x-data="{ open: <?php echo e($studentControlOpen ? 'true' : 'false'); ?> }">
                <button @click="open = !open" class="sidebar-group-btn">
                    <span class="flex items-center gap-3">
                        ...
                        <span><?php echo e(__('admin.sidebar_students_hub')); ?></span>
                    </span>
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.students-accounts.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.students-accounts.*') ? 'active' : ''); ?>">
                            ...
                            <?php $studentsCount = (int) ($sb['students_count'] ?? 0); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.subscriptions.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.subscriptions.*') ? 'active' : ''); ?>">
                            ...
                            <?php $activeSubsCount = (int) ($sb['active_subs_count'] ?? 0); ?>
                    ...
                    <?php endif; ?>
                    <?php if(($isFull || $u->hasPermission('manage.tutor-lessons')) && Route::has('admin.tutor-lessons.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.tutor-lessons.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutor-lessons.*') ? 'active' : ''); ?>">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.orders.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">
                            ...
                            <?php $pendingOrdersSales = (int) ($sb['pending_orders'] ?? 0); ?>
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.employee-tasks.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.employee-tasks.*') ? 'active' : ''); ?>">
                            ...
                            <?php $pendingTasksHR = (int) ($sb['pending_tasks'] ?? 0); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.leaves.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.leaves.*') ? 'active' : ''); ?>">
                            ...
                            <?php $pendingLeavesHR = (int) ($sb['pending_leaves'] ?? 0); ?>
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.orders.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">
                            ...
                            <?php $pendingOrders = (int) ($sb['pending_orders'] ?? 0); ?>
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.withdrawals.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.withdrawals.*') ? 'active' : ''); ?>">
                            ...
                            <?php $pendingWithdrawals = (int) ($sb['pending_withdrawals'] ?? 0); ?>
            ...
            <?php if($isFull || $u->hasPermission('manage.coupons') || $u->hasPermission('manage.referrals') || $u->hasPermission('manage.loyalty') || $u->hasPermission('manage.popup-ads') || $u->hasPermission('manage.promotional-videos') || $u->hasPermission('manage.personal-branding')): ?>
            ...
            <li x-data="{ open: <?php echo e($marketingOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <?php endif; ?>
                    <?php if($isFull || $u->hasPermission('manage.promotional-videos') || $u->hasPermission('manage.popup-ads')): ?>
                    <li><a href="<?php echo e(route('admin.promotional-videos.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.promotional-videos.*') ? 'active' : ''); ?>"><i class="fab fa-youtube"></i><span><?php echo e(__('admin.promotional_videos')); ?></span></a></li>
                    <?php endif; ?>
            ...
            <?php if($isFull || $u->hasPermission('manage.subscriptions') || $u->hasPermission('manage.packages') || $u->hasPermission('manage.tutor-lessons')): ?>
            ...
            <li x-data="{ open: <?php echo e($paidSubscriptionsOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <li><a href="<?php echo e(route('admin.subscriptions.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.subscriptions.*') ? 'active' : ''); ?>"><i class="fas fa-calendar-check"></i><span><?php echo e(__('admin.subscriptions')); ?></span></a></li>
                    <?php endif; ?>
                    <?php if($isFull || $u->hasPermission('manage.tutor-lessons')): ?>
                    <?php if(Route::has('admin.tutor-lessons.index')): ?>
                    <li><a href="<?php echo e(route('admin.tutor-lessons.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutor-lessons.*') ? 'active' : ''); ?>"><i class="fas fa-user-clock"></i><span>رقابة حصص المعلمين</span></a></li>
                    <?php endif; ?>
                    <?php endif; ?>
            ...
            <li x-data="{ open: <?php echo e($contentManagementOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <li><a href="<?php echo e(route('admin.academic-subjects.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.academic-subjects.*') ? 'active' : ''); ?>"><i class="fas fa-book"></i><span><?php echo e(__('admin.academic_subjects')); ?></span></a></li>
                    <li><a href="<?php echo e(route('admin.academic-years.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.academic-years.*') ? 'active' : ''); ?>"><i class="fas fa-layer-group"></i><span><?php echo e(__('admin.academic_years')); ?></span></a></li>
                    <?php endif; ?>
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.employee-tasks.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.employee-tasks.*') ? 'active' : ''); ?>">
                            ...
                            <?php $pendingTasks = (int) ($sb['pending_tasks'] ?? 0); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.tasks.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tasks.*') ? 'active' : ''); ?>">
                            ...
                            <?php $pendingInstructorTasks = (int) ($sb['pending_instructor_tasks'] ?? 0); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.instructor-requests.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.instructor-requests.*') ? 'active' : ''); ?>">
                            ...
                            <?php $pendingInstructorRequests = (int) ($sb['pending_instructor_requests'] ?? 0); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.leaves.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.leaves.*') ? 'active' : ''); ?>">
                            ...
                            <?php $pendingLeaves = (int) ($sb['pending_leaves'] ?? 0); ?>
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    <li>
                        <a href="<?php echo e(route('admin.certificates.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.certificates.index') ? 'active' : ''); ?>">
                            ...
                            <?php $totalCertificates = (int) ($sb['total_certificates'] ?? 0); ?>
                    ...
                    <?php $pendingCertificates = (int) ($sb['pending_certificates'] ?? 0); ?>
    ...
    <div class="px-3 py-3 flex-shrink-0 sidebar-foot border-t">
        <div class="sidebar-user-wrap flex items-center gap-2.5 p-2.5 rounded-xl transition-colors">
            <?php if(auth()->user()->profile_image): ?>
                ...
                <div class="w-8 h-8 rounded-lg hidden flex items-center justify-center text-white font-bold text-xs flex-shrink-0" style="background: linear-gradient(135deg, var(--admin-primary), var(--admin-purple));"><?php echo e(mb_substr(auth()->user()->name, 0, 1)); ?></div>
            <?php else: ?>
            ...
            <div class="sidebar-user-info flex-1 min-w-0">
                <p class="text-xs font-semibold text-slate-700 truncate leading-tight"><?php echo e(auth()->user()->name); ?></p>
                <p class="text-[10px] text-slate-500 truncate leading-tight"><?php echo e(auth()->user()->phone); ?></p>
            </div>
            <div class="sidebar-user-info w-1.5 h-1.5 bg-emerald-400 rounded-full ring-2 ring-emerald-400/20 flex-shrink-0"></div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\sana\resources\views\layouts\admin-sidebar.blade.php ENDPATH**/ ?>