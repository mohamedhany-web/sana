        ...
        <div class="min-w-0 hidden sm:block">
            <?php if(!$onDashboard): ?>
                <p class="ins-page-breadcrumb mb-0.5">
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-[#283593] dark:text-indigo-400 hover:underline no-underline"><?php echo e(__('instructor.dashboard')); ?></a>
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" @click.away="open = false" x-cloak x-transition class="absolute left-0 mt-2 w-80 ins-dd z-50">
                <div class="px-4 py-3 border-b border-slate-100 dark:border-slate-700 flex items-center justify-between gap-2">
                    <h3 class="text-sm font-bold text-slate-900 dark:text-slate-100"><?php echo e($isRtl ? 'الإشعارات' : 'Notifications'); ?></h3>
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" @click.away="open = false" x-cloak x-transition class="absolute left-0 mt-2 w-56 ins-dd z-50">
                <div class="px-4 py-3 border-b border-slate-100 dark:border-slate-700">
                    ...
                    <span class="inline-flex mt-2 text-[10px] font-bold uppercase tracking-wide px-2 py-0.5 rounded-md bg-[#FFE5F7] text-[#283593] dark:bg-indigo-950/50 dark:text-indigo-300"><?php echo e(__('instructor.instructor_role')); ?></span>
                </div>
                <div class="p-1.5 space-y-0.5">
                    <a href="<?php echo e(route('instructor.profile')); ?>" class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 no-underline">
                    ...
                    <a href="<?php echo e(route('home')); ?>" target="_blank" rel="noopener" class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 no-underline">
