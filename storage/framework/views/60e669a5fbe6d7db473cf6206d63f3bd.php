...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1"><?php echo e($lecture->title); ?></p>
            </div>
    ...
    <!-- النموذج -->
    <form action="<?php echo e(route('instructor.lectures.update', $lecture)); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"><?php echo e(old('description', $lecture->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php $__currentLoopData = $lecture->materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex flex-wrap items-center gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <div class="flex-1 min-w-0">
                            <span class="font-medium text-gray-900"><?php echo e($mat->title ?: $mat->file_name); ?></span>
                            <span class="text-xs text-gray-500 block"><?php echo e($mat->file_name); ?></span>
                        </div>
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"><?php echo e(old('notes', $lecture->notes)); ?></textarea>
