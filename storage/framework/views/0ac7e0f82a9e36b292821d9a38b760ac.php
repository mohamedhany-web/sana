        ...
        <div class="section-card-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="min-w-0">
                <nav class="text-sm text-slate-500 mb-2">
                    ...
                    <span class="mx-2">/</span>
                    <span class="text-slate-700 truncate"><?php echo e(Str::limit($advancedCourse->title, 40)); ?></span>
                </nav>
                <h1 class="text-xl sm:text-2xl font-bold text-slate-800 mt-1 truncate"><?php echo e($advancedCourse->title); ?></h1>
            ...
            <div class="section-card">
                <div class="section-card-header flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($advancedCourse->is_active ? 'bg-emerald-100 text-emerald-800' : 'bg-slate-100 text-slate-700'); ?>">
                ...
                <div class="p-6 sm:p-8">
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                        <div class="p-3 bg-slate-50 rounded-xl">
                            ...
                            <div class="text-sm font-semibold text-slate-800 truncate" title="<?php echo e($advancedCourse->title); ?>"><?php echo e(Str::limit($advancedCourse->title, 25)); ?></div>
                        </div>
                        <div class="p-3 bg-slate-50 rounded-xl">
                            <div class="text-xs font-medium text-slate-500 mb-0.5">المسار / المدرّس</div>
                            <div class="text-sm font-semibold text-slate-800"><?php echo e($advancedCourse->category ?? '—'); ?> · <?php echo e($advancedCourse->instructor?->name ?? '—'); ?></div>
                        </div>
                        <div class="p-3 bg-slate-50 rounded-xl">
                    ...
                    <?php if($advancedCourse->description): ?>
                        <div>
                            ...
                            <div class="text-slate-800 bg-slate-50 p-4 rounded-xl border border-slate-100"><?php echo e($advancedCourse->description); ?></div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="space-y-4">
            <div class="stat-card p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($stats['total_lessons']); ?></p>
            ...
            <div class="stat-card p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($stats['active_students']); ?></p>
            ...
            <div class="stat-card p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($stats['pending_orders']); ?></p>
            ...
            <div class="stat-card p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(floor($stats['total_duration'] / 60)); ?></p>
