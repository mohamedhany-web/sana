                    ...
                    <div class="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-200">
                        ...
                        <div class="mt-3 pt-3 border-t border-purple-200">
                            <div class="grid grid-cols-2 gap-4 text-xs">
                                <div>
                                    <span class="text-gray-500"><?php echo e(__('المبلغ:')); ?></span>
                                    <span class="font-bold text-gray-900 mr-2"><?php echo e(number_format($expense->invoice->total_amount, 2)); ?> <?php echo e($expense->invoice->currency ?? currency_code()); ?></span>
                                </div>
                                <div>
                                    <span class="text-gray-500"><?php echo e(__('الحالة:')); ?></span>
                                    <span class="font-bold 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\expenses\show.blade.php ENDPATH**/ ?>