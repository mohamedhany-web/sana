        ...
        <div class="rounded-2xl bg-white shadow-lg border border-sky-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-black text-gray-900"><?php echo e(number_format($plan->total_amount ?? 0, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                </div>
        ...
        <div class="rounded-2xl bg-white shadow-lg border border-amber-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-black text-gray-900"><?php echo e(number_format($plan->deposit_amount ?? 0, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-base font-semibold text-gray-900"><?php echo e(number_format($totalFinanced, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-500 uppercase">إجمالي الدفعات المقدمة</p>
                        <p class="mt-2 text-base font-semibold text-gray-900"><?php echo e(number_format($totalDeposits, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
                    <div>
                            ...
                            <div class="p-4 rounded-2xl border border-gray-100 bg-gray-50/70 space-y-3">
                                ...
                                <div class="grid grid-cols-2 gap-3 text-xs text-gray-600">
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm font-semibold text-gray-900"><?php echo e(number_format($agreement->total_amount ?? 0, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                                    </div>
                                    <div>
                                        <p class="uppercase text-[11px]">دفعة مقدمة</p>
                                        <p class="mt-1 text-sm font-semibold text-gray-900"><?php echo e(number_format($agreement->deposit_amount ?? 0, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                                    </div>
                                    <div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                ...
                <ul class="space-y-3 text-sm text-gray-600">
                    <li class="flex items-start gap-2">
                        ...
                        الدفعة المقدمة: <?php echo e(number_format($plan->deposit_amount ?? 0, 2)); ?> <?php echo e(__('public.currency')); ?> تُسدد عند التعاقد.
                    </li>
                    <li class="flex items-start gap-2">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\installments\plans\show.blade.php ENDPATH**/ ?>