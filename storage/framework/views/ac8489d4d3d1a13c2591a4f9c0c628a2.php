                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div class="space-y-1">
                                ...
                                <select name="role" id="role" required class="w-full rounded-xl border-2 border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all hover:border-slate-400 cursor-pointer">
                                    ...
                                    <?php $rolePreset = old('role', request('role')); ?>
                                    <option value="super_admin" <?php echo e($rolePreset == 'super_admin' ? 'selected' : ''); ?>>إداري كامل (Super Admin)</option>
                                    <option value="instructor" <?php echo e($rolePreset == 'instructor' ? 'selected' : ''); ?>>مدرس / معلم</option>
                                    <option value="student" <?php echo e($rolePreset == 'student' ? 'selected' : ''); ?>><?php echo e(__('admin.student_role_label')); ?></option>
                                </select>
