...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('instructor.live-sessions.index')); ?>" class="p-2 rounded-lg hover:bg-slate-100 text-slate-500 transition-colors"><i class="fas fa-arrow-right"></i></a>
            <div>
        ...
        <div class="flex items-center gap-2">
            <?php if($liveSession->isLive()): ?>
                <a href="<?php echo e(route('instructor.live-sessions.room', $liveSession)); ?>" class="px-4 py-2 bg-red-600 hover:bg-red-600 text-white rounded-lg text-sm font-semibold shadow-lg shadow-red-500/25 transition-all">
    ...
    <div class="bg-red-50 border border-red-200 rounded-xl p-4 flex items-center gap-3">
        ...
        <span class="font-semibold text-red-700">البث مباشر الآن — بدأ <?php echo e($liveSession->started_at?->diffForHumans()); ?></span>
    </div>
    <?php endif; ?>
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div class="grid sm:grid-cols-2 gap-4 text-sm">
                    ...
                    <div><span class="text-slate-500">الحد الأقصى:</span> <span class="font-semibold text-slate-800 mr-2"><?php echo e($liveSession->max_participants); ?></span></div>
                </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-full bg-<?php echo e($att->role_in_session === 'instructor' ? 'blue' : 'slate'); ?>-100 flex items-center justify-center">
                            ...
                            <div>
                                <p class="text-sm font-medium text-slate-800"><?php echo e($att->user?->name); ?></p>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-5">
                ...
                <div class="p-2 bg-slate-50 rounded-lg flex items-center justify-between">
                    <span class="text-sm text-slate-700"><?php echo e($rec->title ?? 'تسجيل'); ?></span>
                    <?php if($rec->getUrl()): ?>
