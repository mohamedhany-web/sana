...
<body>
            ...
            <div class="mx-join-card mx-join-card--dark">
                <?php if(!empty($meetingEnded)): ?>
                    ...
                    <?php if($meeting && $meeting->title): ?>
                        <p class="mx-join-meta font-semibold"><?php echo e($meeting->title); ?></p>
                    <?php endif; ?>
                ...
                <?php else: ?>
                    ...
                    <?php if($meeting && $meeting->title): ?>
                        <p class="mx-join-meta font-semibold mb-2"><?php echo e($meeting->title); ?></p>
                    <?php endif; ?>
                    ...
                    <div class="mx-join-field space-y-4">
                        <?php if($isAuthenticated): ?>
                            <div class="mx-join-user-chip">
                                <span class="mx-join-user-chip__avatar"><?php echo e(mb_substr($displayName, 0, 1)); ?></span>
                                <span class="min-w-0 flex-1">
                                    <span class="block text-sm font-bold text-slate-100 truncate"><?php echo e($displayName); ?></span>
                                    <span class="block text-xs text-slate-400 truncate" dir="ltr"><?php echo e($displayEmail); ?></span>
                                </span>
                        ...
                        <button type="button" id="btn-join" class="mx-btn-join">
                            <i class="fas fa-video"></i>
                            <span id="btn-join-label"><?php echo e($autoJoin ? 'جاري الانضمام...' : 'انضم الآن'); ?></span>
                        </button>
                    </div>
    ...
    <div id="meeting-screen" class="hidden mx-meeting-body h-screen">
        <header class="mx-meeting-room-header min-h-14 shrink-0 flex flex-col gap-2 md:flex-row md:items-center md:justify-between md:gap-2">
            <div class="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                <a href="<?php echo e(route('home')); ?>" class="mx-meeting-brand-link shrink-0">
                ...
                <div class="flex items-center gap-1.5 min-w-0">
                    ...
                    <span class="mx-meeting-title text-xs sm:text-sm"><?php echo e($meeting?->title ?: 'غرفة '.$code); ?></span>
                    <span class="mx-meeting-code-chip shrink-0"><?php echo e($code); ?></span>
                </div>
            </div>
    ...
    <script>
        ...
        const authDisplayName = <?php echo json_encode($displayName, 15, 512) ?>;
        const authDisplayEmail = <?php echo json_encode($displayEmail, 15, 512) ?>;
        const autoJoin = <?php echo json_encode($autoJoin, 15, 512) ?>;
        let api = null;
        let joinToken = null;
