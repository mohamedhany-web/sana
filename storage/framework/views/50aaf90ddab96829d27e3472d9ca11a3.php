        ...
        <div class="section-card-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="min-w-0">
                <nav class="text-sm text-slate-500 mb-2">
                    ...
                    <span class="mx-2">/</span>
                    <a href="<?php echo e(route('admin.advanced-courses.show', $advancedCourse)); ?>" class="hover:text-sky-600 truncate"><?php echo e(Str::limit($advancedCourse->title, 30)); ?></a>
                    <span class="mx-2">/</span>
                    <span class="text-slate-700">الطلبات</span>
                </nav>
                <h1 class="text-xl sm:text-2xl font-bold text-slate-800 mt-1">طلبات التسجيل</h1>
                <p class="text-sm text-slate-600 mt-1 truncate"><?php echo e($advancedCourse->title); ?></p>
            </div>
    ...
    <div class="section-card p-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="flex items-center gap-4 min-w-0">
                ...
                <div class="min-w-0">
                    <h3 class="text-lg font-bold text-slate-800 truncate"><?php echo e($advancedCourse->title); ?></h3>
            ...
            <div class="text-center px-4 py-2 bg-sky-50 rounded-xl border border-sky-100">
                <div class="text-2xl font-bold text-sky-600"><?php echo e($orders->total()); ?></div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="stat-card p-5">
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($orders->where('status', 'pending')->count()); ?></p>
        ...
        <div class="stat-card p-5">
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($orders->where('status', 'approved')->count()); ?></p>
        ...
        <div class="stat-card p-5">
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($orders->where('status', 'rejected')->count()); ?></p>
        ...
        <div class="stat-card p-5">
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($orders->total()); ?></p>
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 bg-sky-100 rounded-xl flex items-center justify-center flex-shrink-0">
                                            <span class="text-sky-600 font-semibold"><?php echo e(substr($order->user->name ?? '', 0, 1)); ?></span>
                                        </div>
                                        <div class="min-w-0">
                                            <div class="text-sm font-semibold text-slate-800"><?php echo e($order->user->name ?? '—'); ?></div>
                                            <div class="text-sm text-slate-500 truncate max-w-[180px]"><?php echo e($order->user->email ?? '—'); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-800 font-medium"><?php echo e($paymentLabel); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-slate-800"><?php echo e(number_format($order->amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500"><?php echo e($order->created_at->format('Y-m-d H:i')); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
