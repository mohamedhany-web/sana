            ...
            <div class="dashboard-card-lecture rounded-2xl p-5 shadow-lg">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200">
                        ...
                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold shadow-md <?php echo e($lecture->has_attendance_tracking ? 'bg-emerald-600 text-white' : 'bg-slate-400 text-white'); ?>">
                    ...
                    <div class="flex items-center justify-between p-3 bg-amber-50 rounded-xl border border-amber-200">
                        ...
                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold shadow-md <?php echo e($lecture->has_assignment ? 'bg-emerald-600 text-white' : 'bg-slate-400 text-white'); ?>">
                    ...
                    <div class="flex items-center justify-between p-3 bg-violet-50 rounded-xl border border-violet-200">
                        ...
                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold shadow-md <?php echo e($lecture->has_evaluation ? 'bg-emerald-600 text-white' : 'bg-slate-400 text-white'); ?>">
