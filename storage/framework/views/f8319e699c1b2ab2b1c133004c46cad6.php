                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <?php elseif($p->status === 'paid' && $p->transfer_receipt_path): ?>
                                <a href="<?php echo e(public_storage_url($p->transfer_receipt_path)); ?>" target="_blank" class="inline-flex items-center gap-1 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm rounded-lg font-medium">إيصال</a>
                            <?php else: ?>
                                —
                            <?php endif; ?>
                        </td>
