...
<?php $__env->startSection('title', 'بوابة الدفع - التقارير المحاسبية - Sana'); ?>
    ...
    <section class="rounded-3xl bg-white/95 backdrop-blur border border-slate-200 shadow-lg overflow-hidden">
        ...
        <div class="p-5 sm:p-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="rounded-2xl border border-sky-200 bg-sky-50/80 p-5">
                ...
                <p class="text-2xl font-black text-sky-900 mt-2"><?php echo e(number_format($gatewaySummary['gross'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
            </div>
            <div class="rounded-2xl border border-amber-200 bg-amber-50/80 p-5">
                ...
                <p class="text-2xl font-black text-amber-900 mt-2"><?php echo e(number_format($gatewaySummary['fees'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
            </div>
            <div class="rounded-2xl border border-violet-200 bg-violet-50/80 p-5">
                ...
                <p class="text-2xl font-black text-violet-900 mt-2"><?php echo e(number_format($gatewaySummary['net'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\accounting\reports-payment-gateway.blade.php ENDPATH**/ ?>