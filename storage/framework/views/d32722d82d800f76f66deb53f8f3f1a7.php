<div class="flex flex-col h-full min-h-0">
    ...
    <nav class="flex-1 overflow-y-auto sidebar-scroll px-0 py-2 space-y-0.5 min-h-0">
        ...
        <?php if(Route::has('parent.tutor-lessons.hub')): ?>
        <a href="<?php echo e(route('parent.tutor-lessons.hub')); ?>" @click="if (window.innerWidth < 1024) sidebarOpen = false"
           class="ins-nav <?php echo e(request()->routeIs('parent.tutor-lessons.*') ? 'active' : ''); ?>">
            <span class="ins-icon bg-violet-100 text-violet-600">
                <i class="fas fa-chalkboard-user text-sm"></i>
            </span>
            <span class="flex-1 truncate"><?php echo e(__('tutor.parent_hub_title')); ?></span>
        </a>
        <?php endif; ?>
