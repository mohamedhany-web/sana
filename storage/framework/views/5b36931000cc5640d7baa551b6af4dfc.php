    ...
    <div class="content-wrapper min-h-screen flex flex-col"
        ...
        <header class="top-navbar top-navbar--brand sticky top-0 z-40 flex items-center px-4 lg:px-7 gap-3">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 mb-0.5 hidden sm:block"><?php echo e($platformName ?? config('brand.name', config('app.name'))); ?> · لوحة الإدارة</p>
