...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white rounded-xl shadow-lg p-6 border-2 border-amber-200">
            ...
            <p class="text-3xl font-black text-amber-700"><?php echo e(number_format($pendingTotal, 2)); ?> <?php echo e(__('public.currency')); ?></p>
        </div>
        <div class="bg-white rounded-xl shadow-lg p-6 border-2 border-green-200">
            ...
            <p class="text-3xl font-black text-green-700"><?php echo e(number_format($paidTotal, 2)); ?> <?php echo e(__('public.currency')); ?></p>
        </div>
    </div>
            ...
            <table class="w-full">
                <thead class="bg-slate-100 text-right text-sm text-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3">المبلغ/المعدل (<?php echo e(__('public.currency')); ?>)</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-6 py-4 font-bold text-gray-900"><?php echo e(number_format((float)($agr->rate ?? 0), 2)); ?> <?php echo e(__('public.currency')); ?></td>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-6 py-4 font-bold text-gray-900"><?php echo e(number_format($p->amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <?php else: ?>
                                <?php if($p->transfer_receipt_path): ?>
                                    <a href="<?php echo e(public_storage_url($p->transfer_receipt_path)); ?>" target="_blank" class="inline-flex items-center gap-1 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm rounded-lg font-medium">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\salaries\instructor.blade.php ENDPATH**/ ?>