...
<?php $__env->startSection('title', 'الإحالات - ' . config('app.name', 'Sana')); ?>
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-black text-purple-600"><?php echo e(number_format($stats['total_rewards'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-black text-rose-600"><?php echo e(number_format($stats['total_discounts'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
