            ...
            <div class="sana-hero__grid">
                <div class="sana-hero__content sana-reveal">
                    <p class="sana-hero__eyebrow">
                        ...
                        <?php echo e($pub('home_hero_eyebrow')); ?>

                    </p>
                    <h1 class="sana-hero__title">
                        <?php echo e($pub('home_hero_title')); ?>

                        <span class="hl"><?php echo e(__('public.home_hero_title_highlight')); ?></span>
                    </h1>
                    <p class="sana-hero__desc"><?php echo e($pub('home_hero_desc')); ?></p>
                    ...
                    <ul class="sana-hero__trust" aria-label="خطوات الرحلة">
                        <li><i class="fas fa-clipboard-check"></i> <?php echo e(__('public.audience_student_step_1')); ?></li>
                        <li><i class="fas fa-user-check"></i> <?php echo e(__('public.audience_student_step_2')); ?></li>
                        <li><i class="fas fa-chart-line"></i> <?php echo e(__('public.audience_student_step_3')); ?></li>
                    </ul>
                ...
                <div class="sana-hero__visual sana-reveal" aria-hidden="true">
                    <?php echo $__env->make('landing.sana.sections.hero-scene', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sana-container">
        <div class="sana-hero-stats sana-hero-stats--trust sana-reveal" aria-label="لماذا تثق بسنا">
            <div class="sana-hero-stats__item">
                ...
                <div>
                    <strong><?php echo e(__('public.home_trust_1_title')); ?></strong>
                    <span><?php echo e(__('public.home_trust_1_sub')); ?></span>
                </div>
            </div>
            <div class="sana-hero-stats__item">
                <span class="sana-hero-stats__icon"><i class="fas fa-comments"></i></span>
                <div>
                    <strong><?php echo e(__('public.home_trust_2_title')); ?></strong>
                    <span><?php echo e(__('public.home_trust_2_sub')); ?></span>
                </div>
            </div>
            <div class="sana-hero-stats__item">
                <span class="sana-hero-stats__icon"><i class="fas fa-chart-simple"></i></span>
                <div>
                    <strong><?php echo e(__('public.home_trust_3_title')); ?></strong>
                    <span><?php echo e(__('public.home_trust_3_sub')); ?></span>
                </div>
            </div>
        </div>
    </div>
</section>
<?php /**PATH C:\xampp\htdocs\sana\resources\views\landing\sana\sections\hero.blade.php ENDPATH**/ ?>