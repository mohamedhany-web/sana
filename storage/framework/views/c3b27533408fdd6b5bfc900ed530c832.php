...
<nav class="sanua-rail-nav" aria-label="تنقل الطالب">
    <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <a href="<?php echo e(route($item['route'])); ?>"
           ...
           class="sanua-rail-link <?php echo e($active ? 'is-active' : ''); ?>"
           title="<?php echo e($item['label']); ?>">
            <span class="sanua-rail-icon"><i class="fas <?php echo e($item['icon']); ?>"></i></span>
            <span class="sanua-rail-label"><?php echo e($item['label']); ?></span>
        </a>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</nav>
<?php /**PATH C:\xampp\htdocs\sana\resources\views/layouts/partials/sanua-student-rail.blade.php ENDPATH**/ ?>