...
<main>
    ...
    <?php if(($promotionalVideos ?? collect())->isNotEmpty()): ?>
        <?php echo $__env->make('landing.sana.sections.promotional-videos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
</main>
