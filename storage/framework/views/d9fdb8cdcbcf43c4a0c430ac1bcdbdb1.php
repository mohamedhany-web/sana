...
<div x-show="step === 2" x-cloak class="ix-step-panel space-y-4" data-tutor-step="2">
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        ...
        <div><label class="ta-label">LinkedIn <span class="text-slate-400 font-normal text-xs">(اختياري)</span></label><input type="url" name="linkedin_url" class="ta-field" dir="ltr" placeholder="https://" value="<?php echo e(old('linkedin_url')); ?>"></div>
    </div>
