...
<div x-show="step === 1" x-cloak class="ix-step-panel">
    ...
    <p class="text-xs text-amber-800 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-6">
        ...
        <a href="<?php echo e(route('public.teacher-policy')); ?>" class="font-bold underline hover:text-amber-900" target="_blank" rel="noopener">اقرأ سياسة المعلمين كاملة</a>
    </p>
...
<div x-show="step === 2" x-cloak class="ix-step-panel space-y-4">
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        ...
        <div><label class="ta-label">LinkedIn (اختياري)</label><input type="url" name="linkedin_url" class="ta-field" dir="ltr" placeholder="https://" value="<?php echo e(old('linkedin_url')); ?>"></div>
    </div>
...
<div x-show="step === 5" x-cloak class="ix-step-panel space-y-4">
    ...
    <input type="text" name="specializations_other" class="ta-field mb-4" placeholder="أخرى (حدّد)" value="<?php echo e(old('specializations_other')); ?>">
    ...
    <div class="overflow-x-auto rounded-xl border border-slate-200">
        <table class="w-full text-sm">
            ...
            <tr class="border-t border-slate-100">
                ...
                <td class="p-2"><input type="text" name="weekly_availability[<?php echo e($day); ?>][notes]" class="ta-field text-xs" value="<?php echo e($oldWeekly[$day]['notes'] ?? ''); ?>"></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
...
<div x-show="step === 8" x-cloak class="ix-step-panel space-y-4">
    ...
    <div><label class="ta-label">أو رابط فيديو (Drive / YouTube)</label>
        <input type="url" name="demo_video_link" class="ta-field" dir="ltr" placeholder="https://" value="<?php echo e(old('demo_video_link')); ?>"></div>
...
<div x-show="step === 10" x-cloak class="ix-step-panel space-y-4">
    ...
    <p class="text-sm text-slate-600 mb-3">
        راجع <a href="<?php echo e(route('public.teacher-policy')); ?>" class="font-bold text-violet-700 underline hover:text-violet-900" target="_blank" rel="noopener">سياسة المعلمين وحماية أسرار المنصة</a> قبل الموافقة على البنود أدناه.
    </p>
  <div class="space-y-2">
...
<div x-show="step === 11" x-cloak class="ix-step-panel space-y-4">
    ...
    <div class="ta-check-grid mb-4" style="max-height:none">
        <label class="ta-check-item"><input type="checkbox" name="matching_modes[]" value="pick_teacher" checked> <?php echo e(__('tutor.matching_pick_teacher')); ?></label>
        <label class="ta-check-item"><input type="checkbox" name="matching_modes[]" value="self_schedule"> <?php echo e(__('tutor.matching_self_schedule')); ?></label>
        <label class="ta-check-item"><input type="checkbox" name="matching_modes[]" value="assisted"> <?php echo e(__('tutor.matching_assisted')); ?></label>
    </div>
...
<?php /**PATH C:\xampp\htdocs\sana\resources\views\tutor\partials\apply-steps.blade.php ENDPATH**/ ?>