<?php $__env->startSection('title', 'طلب سحب جديد - ' . config('app.name', 'Sana')); ?>
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-black"><?php echo e(number_format($stats['total_earned'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-black"><?php echo e(number_format($stats['total_withdrawn'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
                    <div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
            ...
            <div class="bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-black"><?php echo e(number_format($stats['pending_withdrawals'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
                    <div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
            ...
            <div class="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-black"><?php echo e(number_format($stats['available_amount'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
                    <div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-amber-50 to-white">
            ...
            <p class="text-sm text-gray-600 mt-1">المبلغ المتاح للسحب: <span class="font-bold text-amber-700"><?php echo e(number_format($stats['available_amount'], 2)); ?> <?php echo e(__('public.currency')); ?></span></p>
        </div>
        ...
        <?php else: ?>
            <form action="<?php echo e(route('instructor.withdrawals.store')); ?>" method="POST" class="p-6 md:p-8 space-y-6">
                ...
                <div>
                    <label for="amount" class="block text-sm font-bold text-gray-700 mb-2">المبلغ المطلوب (<?php echo e(__('public.currency')); ?>) <span class="text-red-500">*</span></label>
                    <input type="number" name="amount" id="amount" value="<?php echo e(old('amount')); ?>" min="0.01" step="0.01" max="<?php echo e($stats['available_amount']); ?>" required
                           ...
                           placeholder="0.00">
                    <p class="mt-1 text-xs text-gray-500">الحد الأقصى: <?php echo e(number_format($stats['available_amount'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\instructor\withdrawals\create.blade.php ENDPATH**/ ?>