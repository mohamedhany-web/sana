...
?>
<div class="sm:col-span-2 space-y-3" x-data="tutorVideoStep(<?php echo e($videoMaxMb); ?>, <?php echo json_encode($videoUseExternal, 15, 512) ?>)">
    <div class="rounded-xl bg-sky-50 border border-sky-100 p-4 text-xs text-sky-900 space-y-1">
        <p class="font-bold m-0"><?php echo e($field->label); ?></p>
        ...
        <?php if($field->help_text): ?><p class="m-0"><?php echo e($field->help_text); ?></p><?php endif; ?>
    </div>
    ...
    <div x-show="!useExternalLink" x-cloak class="space-y-2">
        ...
        <p x-show="fileTooLarge" x-cloak class="text-xs text-amber-800 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 m-0">
            الملف يتجاوز <?php echo e($videoMaxMb); ?> ميجابايت. استخدم رابطاً خارجياً.
        </p>
    </div>
    ...
    <div>
        ...
        <input type="url" name="demo_video_link" class="ta-field" dir="ltr" placeholder="https://"
               value="<?php echo e(old('demo_video_link')); ?>"
               :required="useExternalLink">
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\sana\resources\views/tutor/partials/field-video-pair.blade.php ENDPATH**/ ?>