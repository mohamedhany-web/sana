...
<nav class="flex flex-wrap gap-2 mb-6">
    <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(route($link['route'])); ?>"
           class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold border transition-colors <?php echo e(request()->routeIs($link['route']) || request()->routeIs($link['active'] ?? ($link['route'].'.*')) ? 'bg-violet-600 text-white border-violet-600' : 'bg-white text-slate-700 border-slate-200 hover:border-violet-300'); ?>">
...
<?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\tutor-lessons\_nav.blade.php ENDPATH**/ ?>