...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php echo $__env->make('admin.advanced-courses.partials.pricing-mode', ['advancedCourse' => new \App\Models\AdvancedCourse()], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="section-card">
                        ...
                        <div class="p-6 sm:p-8 space-y-3 text-sm text-slate-600">
                            ...
                            <div class="flex items-center justify-between">
                                <span>الحالة</span>
                                <span class="font-semibold text-slate-800"><?php echo e(old('is_active', true) ? 'نشط' : 'مسودة'); ?></span>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\advanced-courses\create.blade.php ENDPATH**/ ?>