...
<?php if (! $__env->hasRenderedOnce('a74155ce-2779-48b4-9b05-3692c617c8bb')): $__env->markAsRenderedOnce('a74155ce-2779-48b4-9b05-3692c617c8bb'); ?>
<style>
    ...
    .dark .app-shell-instructor .app-sidebar {
        background: #0f172a;
        border-left-color: #1e293b;
        box-shadow: -8px 0 36px -22px rgba(0, 0, 0, 0.5);
    }
    ...
    .dark .app-shell-instructor .ins-sidebar-brand {
        background: linear-gradient(135deg, rgba(40, 53, 147, 0.32) 0%, #0f172a 62%);
    ...
    .dark .app-shell-instructor .ins-sidebar-stat {
    ...
    .dark .app-shell-instructor .ins-nav-group { color: #94a3b8; }
    ...
    .dark .app-shell-instructor .ins-nav.active {
        background: rgba(40, 53, 147, 0.38) !important;
    ...
    .dark .app-shell-instructor .ins-user-card {
    ...
    .dark .app-shell-instructor .ins-topbar {
    ...
    .dark .app-shell-instructor .ins-topbar-search {
        background: #1e293b;
        border-color: #334155;
    }
    .dark .app-shell-instructor .ins-topbar-search:focus-within {
        border-color: #818cf8;
    ...
    .dark .app-shell-instructor .ins-topbar-search input { color: #e2e8f0; }
    ...
    .dark .app-shell-instructor .ins-icon-btn {
        background: #1e293b;
        border-color: #334155;
        color: #94a3b8;
    }
    ...
    .dark .app-shell-instructor .ins-user-chip {
        background: #1e293b;
        border-color: #334155;
    }
    ...
    .dark .app-shell-instructor .ins-page-title { color: #f1f5f9; }
    .app-shell-instructor .ins-page-breadcrumb {
        font-size: 0.6875rem;
        font-weight: 600;
        color: #64748b;
    }
    .dark .app-shell-instructor .ins-page-breadcrumb { color: #94a3b8; }

    .app-shell-instructor main {
        background: linear-gradient(180deg, #f4f6ff 0%, #f7f8ff 72px, #f7f8ff 100%) !important;
    }
    .dark .app-shell-instructor main {
        background: linear-gradient(180deg, #0f172a 0%, #0c1222 72px, #0c1222 100%) !important;
    }
    ...
    .dark .app-shell-instructor .ins-dd {
        background: #1e293b;
        border-color: #334155;
