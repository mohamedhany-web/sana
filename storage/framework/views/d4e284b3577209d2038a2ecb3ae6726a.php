                        ...
                        <div class="relative"
                            ...
                            <button type="button"
                                ...
                                <span x-show="unread > 0" x-cloak
                                      class="absolute -top-0.5 <?php echo e($empRtl ? '-left-0.5' : '-right-0.5'); ?> min-w-[18px] h-[18px] bg-rose-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center ring-2 ring-white px-1"
                                      x-text="unread > 9 ? '9+' : unread"></span>
                            </button>
                            <div x-show="openNotif" x-cloak
                                 x-transition
                                 class="absolute <?php echo e($empRtl ? 'right-0' : 'left-0'); ?> mt-2 w-80 max-h-[420px] overflow-hidden rounded-xl bg-white shadow-xl border border-gray-200 z-50">
                                <div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between bg-slate-50/80">
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <p class="text-xs text-gray-500 mt-0.5" x-text="unread > 0 ? ('<?php echo e($empRtl ? 'لديك ' : 'You have '); ?>' + unread + '<?php echo e($empRtl ? ' إشعار غير مقروء' : ' unread'); ?>') : '<?php echo e($empRtl ? 'لا توجد إشعارات جديدة' : 'No new notifications'); ?>'"></p>
                                    </div>
...
<?php /**PATH C:\xampp\htdocs\sana\resources\views\layouts\employee.blade.php ENDPATH**/ ?>