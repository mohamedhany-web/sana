...
<div class="space-y-6">
    <div class="rounded-2xl p-5 sm:p-6 bg-white border border-slate-200 shadow-sm">
        <h1 class="text-2xl sm:text-3xl font-bold text-slate-800 mb-1"><?php echo e(__('instructor.agreements_system')); ?></h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        <div class="rounded-2xl p-5 bg-white border border-slate-200 shadow-sm">
            ...
            <p class="text-sm font-medium text-slate-500"><?php echo e(__('instructor.pending')); ?></p>
            <p class="mt-2 text-2xl font-black text-slate-900"><?php echo e(number_format($stats['pending_amount'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
        </div>
        ...
        <div class="rounded-2xl p-5 bg-white border border-slate-200 shadow-sm">
            ...
            <p class="text-sm font-medium text-slate-500"><?php echo e(__('instructor.total_payments')); ?></p>
            <p class="mt-2 text-2xl font-black text-slate-900"><?php echo e(number_format($stats['total_payments'])); ?></p>
        </div>
    </div>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div class="space-y-3">
                <div class="flex items-center flex-wrap gap-2">
                    ...
                    <h3 class="text-lg sm:text-xl font-bold text-slate-900"><?php echo e($activeAgreement->title); ?></h3>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                    <div>
                        <p class="text-slate-500"><?php echo e(__('instructor.agreement_number')); ?></p>
                        <p class="font-bold text-slate-900"><?php echo e($activeAgreement->agreement_number); ?></p>
                    </div>
                    <div>
                        <p class="text-slate-500"><?php echo e(__('instructor.type')); ?></p>
                    ...
                    <div>
                        <p class="text-slate-500"><?php echo e(__('instructor.rate')); ?></p>
                        <p class="font-bold text-slate-900"><?php echo e(number_format($activeAgreement->rate, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-200">
                <thead class="bg-slate-50">
                    <tr>
                        <th class="px-6 py-4 text-right text-xs font-bold tracking-wider text-slate-700 uppercase"><?php echo e(__('instructor.agreement_number')); ?></th>
                        <th class="px-6 py-4 text-right text-xs font-bold tracking-wider text-slate-700 uppercase"><?php echo e(__('instructor.title')); ?></th>
                        <th class="px-6 py-4 text-right text-xs font-bold tracking-wider text-slate-700 uppercase"><?php echo e(__('instructor.type')); ?></th>
                        <th class="px-6 py-4 text-right text-xs font-bold tracking-wider text-slate-700 uppercase"><?php echo e(__('instructor.rate')); ?></th>
                        <th class="px-6 py-4 text-right text-xs font-bold tracking-wider text-slate-700 uppercase"><?php echo e(__('common.status')); ?></th>
                        <th class="px-6 py-4 text-right text-xs font-bold tracking-wider text-slate-700 uppercase"><?php echo e(__('instructor.start_date')); ?></th>
                ...
                <tbody class="divide-y divide-slate-200">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        <td class="px-6 py-4">
                            <p class="font-bold text-slate-900"><?php echo e($agreement->agreement_number); ?></p>
                        </td>
                        <td class="px-6 py-4">
                            <p class="font-semibold text-slate-900"><?php echo e($agreement->title); ?></p>
                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold
                                <?php if($agreement->type == 'course_price'): ?> bg-blue-100 text-blue-700
                                <?php elseif($agreement->type == 'hourly_rate'): ?> bg-violet-100 text-violet-700
                        ...
                        <td class="px-6 py-4">
                            <p class="font-bold text-slate-900"><?php echo e(number_format($agreement->rate, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold
                                <?php if($agreement->status == 'active'): ?> bg-emerald-100 text-emerald-700
                                <?php elseif($agreement->status == 'draft'): ?> bg-slate-100 text-slate-700
                        ...
                        <td class="px-6 py-4">
                            <p class="text-sm text-slate-600"><?php echo e($agreement->start_date->format('Y-m-d')); ?></p>
                        </td>
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center gap-4">
                                ...
                                <div>
                                    <p class="font-bold text-slate-900"><?php echo e(__('instructor.no_agreements')); ?></p>
                                    <p class="text-sm text-slate-600 mt-1"><?php echo e(__('instructor.no_agreements_description')); ?></p>
                                </div>
                            </div>
                        </td>
                    </tr>
