...
<section class="home-benefits" id="why-us"
         x-data="studentBenefits(<?php echo e(count($benefits)); ?>)"
         x-init="init()"
         @mouseenter="pause()"
         @mouseleave="resume()">
    <div class="edu-container">
        <div class="home-benefits__header reveal">
            <h2 class="home-benefits__title">
                <?php echo e($tr('trusted.title_before')); ?>

                <?php echo $__env->make('landing.eduvalt.partials.title-mark', ['text' => config('app.name')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </h2>
        </div>
        <div class="home-benefit-grid reveal-stagger" data-reveal-stagger role="list">
            <?php $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <article class="home-benefit-card home-benefit-card--<?php echo e($b['color']); ?>"
                     :class="{ 'is-active': active === <?php echo e($i); ?> }"
                     @mouseenter="setActive(<?php echo e($i); ?>)"
                     @focusin="setActive(<?php echo e($i); ?>)"
                     tabindex="0"
                     role="listitem">
                <span class="home-benefit-card__icon"><i class="fas <?php echo e($b['icon']); ?>"></i></span>
                <span class="home-benefit-card__title"><?php echo e($tr('trusted.'.$b['key'])); ?></span>
                <span class="home-benefit-card__hint"><?php echo e($tr('trusted.'.$b['key'].'_hint')); ?></span>
            </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <div class="home-benefit-dots" role="tablist" aria-label="<?php echo e($tr('trusted.title')); ?>">
            <?php $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button type="button"
                    :class="{ 'is-on': active === <?php echo e($i); ?> }"
                    @click="setActive(<?php echo e($i); ?>)"
                    :aria-selected="active === <?php echo e($i); ?>"
                    aria-label="<?php echo e($tr('trusted.'.$b['key'])); ?>"></button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
</section>
...
<?php /**PATH C:\xampp\htdocs\sana\resources\views/landing/partials/student-benefits.blade.php ENDPATH**/ ?>