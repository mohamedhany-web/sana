...
<div class="id-page space-y-6 pb-6">
    <section class="id-hero">
        <div class="id-hero-main relative z-[1]">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <p class="text-xs font-bold text-[#283593] uppercase tracking-wider mb-1"><?php echo e(__('instructor.instructor_panel')); ?></p>
                        ...
                        <p class="text-sm text-slate-600 mt-1 mb-0"><?php echo e(__('instructor.overview_activity_today')); ?></p>
        ...
        <aside class="id-hero-aside">
            <p class="text-xs font-bold text-slate-500 uppercase tracking-wider m-0"><?php echo e(__('instructor.quick_actions')); ?></p>
            <?php if($stats['pending_submissions'] > 0): ?>
                ...
                <a href="<?php echo e(route('instructor.assignments.index')); ?>" class="text-xs font-bold text-[#283593] hover:underline"><?php echo e(__('instructor.view_all')); ?> ←</a>
            <?php else: ?>
            ...
            <?php if($liveCount > 0): ?>
                <a href="<?php echo e(route('instructor.live-sessions.index')); ?>" class="inline-flex items-center gap-2 text-xs font-bold text-red-600 mt-1">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <a href="<?php echo e(route('instructor.courses.index')); ?>" class="id-kpi">
            ...
            <div class="text-2xl sm:text-3xl font-black text-slate-900 tabular-nums"><?php echo e(number_format($stats['my_courses'])); ?></div>
            <div class="text-[11px] font-bold text-slate-500 mt-1 uppercase tracking-wide"><?php echo e(__('instructor.my_courses')); ?></div>
        </a>
        <a href="<?php echo e(route('instructor.courses.index')); ?>" class="id-kpi">
            <div class="flex items-center justify-between mb-3">
            ...
            <div class="text-2xl sm:text-3xl font-black text-slate-900 tabular-nums"><?php echo e(number_format($stats['total_students'])); ?></div>
            <div class="text-[11px] font-bold text-slate-500 mt-1 uppercase tracking-wide"><?php echo e(__('instructor.total_students')); ?></div>
        </a>
        <a href="<?php echo e(route('instructor.lectures.index')); ?>" class="id-kpi">
            ...
            <div class="text-2xl sm:text-3xl font-black text-slate-900 tabular-nums"><?php echo e(number_format($stats['total_lectures'])); ?></div>
            <div class="text-[11px] font-bold text-slate-500 mt-1 uppercase tracking-wide">
                ...
                <?php if($stats['upcoming_lectures'] > 0): ?>
                    <span class="text-violet-600 font-normal normal-case">· <?php echo e($stats['upcoming_lectures']); ?> <?php echo e(__('instructor.upcoming')); ?></span>
                <?php endif; ?>
            </div>
        </a>
        <a href="<?php echo e(route('instructor.assignments.index')); ?>" class="id-kpi">
            ...
            <div class="text-2xl sm:text-3xl font-black text-slate-900 tabular-nums"><?php echo e(number_format($stats['total_assignments'])); ?></div>
            <div class="text-[11px] font-bold text-slate-500 mt-1 uppercase tracking-wide">
                <?php echo e(__('instructor.assignments')); ?>

                <?php if($stats['pending_submissions'] > 0): ?>
                    <span class="text-amber-600 font-normal normal-case">· <?php echo e($stats['pending_submissions']); ?> <?php echo e(__('instructor.need_grading')); ?></span>
                <?php endif; ?>
            </div>
        </a>
    </div>
        ...
        <div class="id-panel">
            <div class="id-panel-head">
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-sm font-bold text-slate-900 m-0"><?php echo e(__('instructor.my_recent_courses')); ?></h3>
                </div>
                <a href="<?php echo e(route('instructor.courses.index')); ?>" class="text-xs font-bold text-[#283593] hover:underline"><?php echo e(__('instructor.view_all')); ?> ←</a>
            </div>
            <div>
                ...
                <a href="<?php echo e(route('instructor.courses.show', $course)); ?>" class="id-row">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-bold text-slate-900 truncate m-0"><?php echo e($course->title); ?></p>
        ...
        <div class="id-panel">
            <div class="id-panel-head">
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-sm font-bold text-slate-900 m-0"><?php echo e(__('instructor.upcoming_lectures')); ?></h3>
                </div>
                <a href="<?php echo e(route('instructor.lectures.index')); ?>" class="text-xs font-bold text-[#283593] hover:underline"><?php echo e(__('instructor.view_all')); ?> ←</a>
            </div>
            <div>
                ...
                <a href="<?php echo e(route('instructor.lectures.show', $lecture)); ?>" class="id-row">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-bold text-slate-900 truncate m-0"><?php echo e($lecture->title); ?></p>
                        <p class="text-xs text-slate-500 mt-0.5 m-0"><?php echo e($lecture->course->title ?? __('instructor.not_specified')); ?> · <?php echo e($lecture->scheduled_at->format('m/d H:i')); ?></p>
                    </div>
                    <span class="text-[10px] font-bold text-violet-600 bg-violet-50 px-2 py-1 rounded-lg"><?php echo e($lecture->scheduled_at->diffForHumans()); ?></span>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="px-6 py-14 text-center">
                    <p class="text-sm text-slate-500 mb-3"><?php echo e(__('instructor.no_lectures')); ?></p>
                    <a href="<?php echo e(route('instructor.lectures.create')); ?>" class="text-xs font-bold text-[#283593] hover:underline"><?php echo e(__('instructor.add_lecture')); ?> ←</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="id-panel">
        <div class="id-panel-head">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-sm font-bold text-slate-900 m-0"><?php echo e(__('instructor.assignments_need_grading')); ?></h3>
                <?php if($stats['pending_submissions'] > 0): ?>
                    <span class="min-w-[24px] h-6 px-2 rounded-full bg-amber-100 text-amber-800 text-xs font-black flex items-center justify-center"><?php echo e($stats['pending_submissions']); ?></span>
                <?php endif; ?>
            </div>
            <a href="<?php echo e(route('instructor.assignments.index')); ?>" class="text-xs font-bold text-[#283593] hover:underline"><?php echo e(__('instructor.view_all')); ?> ←</a>
        </div>
        <div>
            ...
            <a href="<?php echo e(route('instructor.assignments.submissions', $submission->assignment)); ?>" class="id-row">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-bold text-slate-900 truncate m-0"><?php echo e($submission->assignment->title ?? __('instructor.assignment_default')); ?></p>
                    <p class="text-xs text-slate-500 mt-0.5 m-0"><?php echo e($submission->student->name ?? __('instructor.student_single')); ?> · <?php echo e($submission->created_at->diffForHumans()); ?></p>
                </div>
                <span class="text-[10px] font-bold text-amber-700 bg-amber-50 px-2.5 py-1 rounded-lg"><?php echo e(__('instructor.grade_assignment')); ?></span>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div>
        <h3 class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-3 px-1"><?php echo e(__('instructor.quick_actions')); ?></h3>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            <a href="<?php echo e(route('instructor.lectures.create')); ?>" class="id-quick">
                ...
                <span class="text-sm font-bold text-slate-700"><?php echo e(__('instructor.add_lecture')); ?></span>
            </a>
            <a href="<?php echo e(route('instructor.assignments.create')); ?>" class="id-quick">
                ...
                <span class="text-sm font-bold text-slate-700"><?php echo e(__('instructor.add_assignment')); ?></span>
            </a>
            <a href="<?php echo e(route('instructor.exams.index')); ?>" class="id-quick">
                ...
                <span class="text-sm font-bold text-slate-700"><?php echo e(__('instructor.manage_exams')); ?></span>
            </a>
            <a href="<?php echo e(route('instructor.attendance.index')); ?>" class="id-quick">
                ...
                <span class="text-sm font-bold text-slate-700"><?php echo e(__('instructor.attendance_absence')); ?></span>
            </a>
        </div>
    </div>
</div>
