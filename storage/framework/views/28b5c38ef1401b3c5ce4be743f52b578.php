<?php $__env->startSection('title', 'الفواتير - التقارير المحاسبية - Sana'); ?>
            ...
            <table class="min-w-full divide-y divide-slate-200 text-right text-sm">
                ...
                <tbody class="divide-y divide-slate-200">
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 font-semibold"><?php echo e(number_format($invoice->total_amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                        <td class="px-4 py-3">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\accounting\reports-invoices.blade.php ENDPATH**/ ?>