                            ...
                            <div class="flex flex-col">
                                <?php if(($path->price ?? 0) > 0): ?>
                                    <span class="text-base lg:text-lg font-black text-blue-600 flex items-center gap-1">
                                        ...
                                        <span class="text-[10px] text-gray-500 font-normal"><?php echo e(__('public.currency')); ?></span>
                                    </span>
                                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\sana\resources\views\public\learning-paths.blade.php ENDPATH**/ ?>