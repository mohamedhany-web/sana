...
<div class="ta-layout">
    ...
    <main class="ta-form-col">
        ...
        <form action="<?php echo e(route('tutor.apply.store')); ?>" method="POST" enctype="multipart/form-data" @submit="onSubmit" id="tutorApplyForm" novalidate>
            <?php echo csrf_field(); ?>
