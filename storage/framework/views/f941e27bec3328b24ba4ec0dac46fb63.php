<?php $__env->startSection('title', __('admin.enroll_student_in_course')); ?>
<?php $__env->startSection('header', __('admin.enroll_student_in_course')); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6">
    
    <nav class="text-sm text-slate-500 flex flex-wrap items-center gap-2">
        <a href="<?php echo e(route('admin.online-enrollments.index')); ?>" class="hover:text-sky-600 font-medium">
            <?php echo e(__('admin.online_enrollments')); ?>

        </a>
        <i class="fas fa-chevron-left text-[10px] text-slate-300"></i>
        <span class="text-slate-800 font-semibold"><?php echo e(__('admin.enroll_student_in_course')); ?></span>
    </nav>
    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-6 py-5 bg-gradient-to-l from-sky-50 to-white border-b border-slate-200 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-black text-slate-900"><?php echo e(__('admin.enroll_student_in_course')); ?></h2>
                    ...
                    <select name="advanced_course_id" id="advanced_course_id" required
                        ...
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($course->id); ?>" <?php echo e(old('advanced_course_id') == $course->id ? 'selected' : ''); ?>>
                                <?php echo e($course->title); ?> — <?php echo e($course->academicYear->name ?? '—'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="status" id="status" required
                        ...
                        <option value="pending" <?php if(old('status') === 'pending'): echo 'selected'; endif; ?>>في الانتظار</option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3"
                          placeholder="اختياري"
                          class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm focus:ring-2 focus:ring-sky-500"><?php echo e(old('notes')); ?></textarea>
