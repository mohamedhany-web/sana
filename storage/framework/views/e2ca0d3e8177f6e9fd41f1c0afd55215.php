...
<div class="space-y-6 w-full min-w-0 max-w-5xl mx-auto">
    <div class="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div class="min-w-0 flex-1">
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2 break-words"><?php echo e($certTitle); ?></h1>
                <p class="text-sm text-gray-500">
                    <?php echo e(__('student.certificate_number_label')); ?>:
                    <span class="font-mono font-semibold text-gray-800"><?php echo e($certificate->certificate_number ?? '—'); ?></span>
                </p>
            </div>
            <a href="<?php echo e(route('student.certificates.index')); ?>" class="inline-flex items-center justify-center gap-2 shrink-0 text-sm font-semibold text-sky-600 hover:text-sky-800 border border-sky-200 bg-sky-50 hover:bg-sky-100 px-4 py-2.5 rounded-xl transition-colors w-full sm:w-auto">
    ...
    <?php else: ?>
        <div class="rounded-xl border-2 border-dashed border-amber-200 bg-amber-50 p-6 sm:p-8 text-center">
            ...
            <p class="text-amber-900 font-semibold"><?php echo e(__('student.certificate_pdf_missing')); ?></p>
            <p class="text-sm text-amber-800/90 mt-2"><?php echo e(__('student.certificate_pdf_contact')); ?></p>
        </div>
    <?php endif; ?>
</div>
