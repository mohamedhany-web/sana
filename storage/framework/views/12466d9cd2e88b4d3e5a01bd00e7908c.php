...
<body>
    <div class="box">
        ...
        <p>مرحباً <?php echo e($user->name); ?>،</p>
        <p>
            نهنئك! تم تفعيل الحساب المخصص لك في
            <strong><?php echo e(config('app.name', 'أكاديمية سنا')); ?></strong>
        ...
        <?php if(!empty($adminNote)): ?>
            <div class="admin-note">
                ...
                <p style="margin:0"><?php echo e($adminNote); ?></p>
            </div>
        <?php endif; ?>

        <p>استخدم نفس البريد الإلكتروني وكلمة المرور التي أنشأتها عند التقديم.</p>

        <a href="<?php echo e(url(route('staff.login'))); ?>" class="btn">تسجيل الدخول الآن</a>

        <p class="note">
            إذا لم تطلب هذا التفعيل أو واجهت مشكلة في الدخول، تواصل مع الدعم عبر
            <?php echo e(config('mail.from.address', 'info@sanaedu.com')); ?>.
        </p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\sana\resources\views/emails/instructor-account-activated.blade.php ENDPATH**/ ?>