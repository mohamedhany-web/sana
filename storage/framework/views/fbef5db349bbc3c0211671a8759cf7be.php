                ...
                <div class="rounded-xl border border-slate-200 p-4 space-y-3 bg-slate-50/40">
                    ...
                    <div class="rounded-lg border border-violet-100 bg-violet-50/50 p-3 space-y-2">
                        <label class="inline-flex items-center gap-2 text-xs font-bold text-slate-700">
                            <input type="hidden" name="plans[<?php echo e($planKey); ?>][limits][tutor_group_enabled]" value="0">
                            <input type="checkbox" name="plans[<?php echo e($planKey); ?>][limits][tutor_group_enabled]" value="1"
                                   <?php if(filter_var(old("plans.{$planKey}.limits.tutor_group_enabled", $plan['limits']['tutor_group_enabled'] ?? false), FILTER_VALIDATE_BOOLEAN)): echo 'checked'; endif; ?>>
                            تفعيل حجز المجموعات
                        </label>
                        <div>
                            <label class="block text-xs font-semibold text-slate-600 mb-1">أقصى حجم مجموعة</label>
                            <input type="number" name="plans[<?php echo e($planKey); ?>][limits][tutor_group_max_size]" min="0" max="30"
                                   value="<?php echo e(old("plans.{$planKey}.limits.tutor_group_max_size", $plan['limits']['tutor_group_max_size'] ?? 0)); ?>"
                                   class="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm">
