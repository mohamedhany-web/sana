<?php $__env->startSection('title', 'تفاصيل الرسالة - Sana'); ?>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-gray-600">
                    <?php echo e(__('عرض تفاصيل الرسالة المرسلة عبر منصة Sana (بريد إلكتروني / قنوات أخرى)')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\messages\show.blade.php ENDPATH**/ ?>