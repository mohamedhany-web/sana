...
<div class="rounded-xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-shadow mb-4 section-block <?php echo e($marginClass); ?>" data-section-id="<?php echo e($section->id); ?>" style="<?php echo e($depth > 0 ? 'margin-right: ' . ($depth * 1.5) . 'rem;' : ''); ?>">
    ...
    <div class="section-body px-4 pb-4 border-t border-slate-100">
                        ...
                        <div class="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <?php if($item->item instanceof \App\Models\Lecture): ?>
                                ...
                                <div class="flex items-center gap-1 shrink-0">
                                    ...
                                    <button type="button" onclick="event.stopPropagation(); deleteLectureFromCurriculum(<?php echo e($item->item->id); ?>, <?php echo e($item->id); ?>)" class="p-1.5 rounded bg-red-50 hover:bg-red-100 text-red-600 text-xs" title="حذف المحاضرة"><i class="fas fa-trash"></i></button>
                                </div>
                            <?php elseif($item->item instanceof \App\Models\Assignment): ?>
                                ...
                                <div class="flex items-center gap-1 shrink-0">
                                    ...
                                    <button type="button" onclick="event.stopPropagation(); removeItem(<?php echo e($item->id); ?>)" class="p-1.5 rounded bg-red-50 hover:bg-red-100 text-red-600 text-xs" title="إزالة من المنهج"><i class="fas fa-times"></i></button>
                                </div>
        ...
        <?php else: ?>
            <div class="sections-children empty-drop-zone mt-4 pr-4 border-r-2 border-slate-100 border-dashed min-h-[52px] rounded-lg bg-slate-50 flex items-center justify-center transition-all" data-parent-id="<?php echo e($section->id); ?>" style="margin-right: 1rem;" data-empty="1"><span class="text-xs text-slate-400 opacity-0 group-hover:opacity-100 curriculum-drag-hint">أفلت قسم هنا</span></div>
        <?php endif; ?>
    </div>
</div>
