<?php $__env->startSection('title', 'تفاصيل الاتفاقية - ' . config('app.name', 'Sana')); ?>
    ...
    <section class="rounded-3xl bg-white/95 backdrop-blur border border-slate-200 shadow-lg overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 p-5 sm:p-8">
            <div class="rounded-2xl border border-slate-200 bg-white/70 p-5">
                ...
                <p class="text-2xl font-bold text-slate-900"><?php echo e(number_format($stats['total_earned'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
            </div>
            <div class="rounded-2xl border border-slate-200 bg-white/70 p-5">
                <p class="text-xs font-semibold text-slate-500 mb-2">معلق</p>
                <p class="text-2xl font-bold text-amber-600"><?php echo e(number_format($stats['pending_amount'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
            </div>
            <div class="rounded-2xl border border-slate-200 bg-white/70 p-5">
                <p class="text-xs font-semibold text-slate-500 mb-2">إجمالي المدفوعات</p>
                ...
                <div class="px-5 py-6 sm:px-8 lg:px-12 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-900"><?php echo e(number_format($agreement->rate, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                        </div>
                        <?php endif; ?>
                        <div>
                        ...
                        <tbody class="divide-y divide-slate-200 bg-white/80 text-sm">
                            <?php $__empty_1 = true; $__currentLoopData = $agreement->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-slate-50">
                                    ...
                                    <td class="px-6 py-4 font-semibold"><?php echo e(number_format($payment->amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                                    <td class="px-6 py-4">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\agreements\show.blade.php ENDPATH**/ ?>