...
<div class="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6" style="background: #f8fafc; min-height: 100vh;">
    ...
    <section class="rounded-2xl bg-white backdrop-blur border-2 border-slate-200 shadow-xl overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 p-5 sm:p-8">
            <div class="dashboard-card rounded-xl border-2 border-emerald-200/50 bg-gradient-to-br from-emerald-50 to-white p-5 shadow-lg">
                ...
                <p class="text-2xl font-black text-emerald-700"><?php echo e(number_format($stats['total_earned'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        <div class="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            ?>
            <section class="rounded-2xl bg-white backdrop-blur border-2 border-blue-200/50 shadow-xl overflow-hidden">
                    ...
                    <table class="min-w-full divide-y divide-slate-200">
                        ...
                        <tbody class="divide-y divide-slate-200 bg-white text-sm">
                            ...
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="px-6 py-4 font-black text-slate-900"><?php echo e(number_format($p->amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                                <td class="px-6 py-4">
                        ...
                        <tbody class="divide-y divide-slate-200 bg-white text-sm">
                            <?php $__empty_1 = true; $__currentLoopData = $agreement->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div>
                                            ...
                                            <?php if($payment->type === 'course_activation' && $payment->enrollment): ?>
                                                ...
                                                <p class="text-xs text-slate-500 mt-1">مبلغ التفعيل: <?php echo e(number_format($payment->enrollment->final_price ?? 0, 2)); ?> <?php echo e(__('public.currency')); ?> → حصتك <?php echo e(number_format($payment->amount, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                                            <?php endif; ?>
                                    ...
                                    <td class="px-6 py-4 font-black text-slate-900"><?php echo e(number_format($payment->amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold 
                                    ...
                                    <td class="px-6 py-4">
                                        <?php if($payment->status == 'paid' && $payment->transfer_receipt_path): ?>
                                            <a href="<?php echo e(public_storage_url($payment->transfer_receipt_path)); ?>" target="_blank" class="inline-flex items-center gap-1 px-2.5 py-1 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-xs font-semibold">
