...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="notes" rows="4" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-emerald-500"><?php echo e(old('notes')); ?></textarea>
            </div>
            <div class="flex gap-3 pt-2">
                ...
                <a href="<?php echo e(route('admin.sales.leads.index')); ?>" class="px-5 py-2.5 rounded-lg bg-slate-200 hover:bg-slate-300 text-slate-800 text-sm font-semibold">إلغاء</a>
            </div>
        </form>
    </div>
</div>
