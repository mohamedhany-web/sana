    ...
    <div class="bg-gradient-to-br from-sky-500 via-sky-600 to-purple-600 rounded-3xl shadow-xl text-white p-8 relative overflow-hidden">
        ...
        <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div class="flex flex-wrap gap-3 justify-end">
                ...
                <?php if($subscription->subscriberIsStudent()): ?>
                <a href="<?php echo e(route('admin.tutor-lessons.bookings')); ?>?search=<?php echo e(urlencode($subscription->user->name)); ?>" class="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-violet-500 text-white font-semibold shadow-lg hover:bg-violet-600 transition-all">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-black text-gray-900"><?php echo e(number_format($subscription->price, 2)); ?> <?php echo e(__('public.currency')); ?></p>
                    </div>
                    <?php if($subscription->teacher_plan_key): ?>
                    <div>
                        <p class="text-xs text-gray-500 uppercase">باقة المدرب</p>
                        <p class="mt-2 text-base font-semibold text-gray-900"><?php echo e($subscription->instructorPlanLabel()); ?></p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-base font-semibold text-violet-800"><?php echo e($subscription->tutorLessonHoursFromLimits()); ?> ساعة</p>
                        <?php if($learningProfile): ?>
                            <p class="text-xs text-slate-500 mt-1">مستهلكة: <?php echo e((int) $learningProfile->lesson_hours_used); ?> — متبقية: <?php echo e(max(0, (int) $learningProfile->lesson_hours_quota - (int) $learningProfile->lesson_hours_used)); ?></p>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                    <div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                ...
                <div class="space-y-3">
                    ...
                    <?php if($subscription->subscriberIsInstructor()): ?>
                    <p class="text-xs text-slate-500 px-1">جلسات Classroom هذا الشهر: <strong><?php echo e($classroomMeetingsMonth ?? 0); ?></strong></p>
                    <?php endif; ?>
                    <?php if($subscription->subscriberIsStudent()): ?>
                    <p class="text-xs text-slate-500 px-1">حجوزات حصص: <strong><?php echo e($tutorBookingsCount ?? 0); ?></strong></p>
                    <?php endif; ?>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\subscriptions\show.blade.php ENDPATH**/ ?>