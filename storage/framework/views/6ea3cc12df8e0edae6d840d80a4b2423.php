        ...
        <div class="sana-sub-hero__grid sana-reveal">
            <div class="sana-sub-hero__content">
                ...
                <div class="sana-sub-hero__actions">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="sana-btn sana-btn--white-outline"><i class="fas fa-user-plus"></i> <?php echo e(__('public.instructors_cta_register')); ?></a>
                </div>
            </div>
    ...
    <div class="sana-container sana-reveal">
        <div class="sana-sub-final__box">
            ...
            <div class="sana-sub-final__actions">
                <a href="<?php echo e(route('register')); ?>" class="sana-btn sana-btn--yellow"><?php echo e(__('public.instructors_cta_register')); ?> <i class="fas fa-arrow-left"></i></a>
