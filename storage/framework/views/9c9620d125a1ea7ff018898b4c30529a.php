        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['total_children'])); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['total_courses'])); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['total_classrooms'])); ?></p>
                </div>
        ...
        <div class="p-6">
            ...
            <div class="mb-6 last:mb-0">
                ...
                <div class="flex items-center gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="flex-1">
                        <h4 class="text-lg font-medium text-gray-900"><?php echo e($child->name); ?></h4>
                        <p class="text-sm text-gray-500"><?php echo e($child->phone); ?></p>
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-blue-600"><?php echo e($child->enrolledCourses->count()); ?></p>
                            </div>
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-green-600"><?php echo e($child->classrooms->count()); ?></p>
                            </div>
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                ?>
                                <p class="text-2xl font-bold text-purple-600"><?php echo e(round($averageProgress)); ?>%</p>
                            </div>
                            ...
                            <div class="bg-white rounded-lg p-3 border border-gray-200">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h6 class="text-sm font-medium text-gray-900 truncate"><?php echo e($course->title); ?></h6>
                                        <p class="text-xs text-gray-500"><?php echo e($course->subject->name ?? 'غير محدد'); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\dashboard\parent.blade.php ENDPATH**/ ?>