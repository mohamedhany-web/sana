    ...
    <div class="sana-container">
        <div class="sana-app-m sana-reveal">
            <div class="sana-app-m__content">
                ...
                <p>حمّل تطبيق <?php echo e(config('app.name')); ?> وتابع دروسك وإشعاراتك من هاتفك.</p>
            ...
            <div class="sana-app-m__phone">
                <?php $heroChar = file_exists(public_path('img/sanua/landing-hero-boy.png')) ? asset('img/sanua/landing-hero-boy.png') : asset('img/sanua/hero-boy.png'); ?>
                <img src="<?php echo e($heroChar); ?>" alt="" class="sana-app-m__char">
...
<?php /**PATH C:\xampp\htdocs\sana\resources\views\landing\sana\sections\app.blade.php ENDPATH**/ ?>