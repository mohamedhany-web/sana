...
<div class="space-y-6">
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5 sm:p-6">
        ...
        <h1 class="text-xl font-bold text-slate-800"><?php echo e(__('instructor.edit_task')); ?></h1>
        <p class="text-sm text-slate-500 mt-0.5"><?php echo e(__('instructor.update_status_or_details')); ?></p>
    </div>
    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5 sm:p-6">
        <form action="<?php echo e(route('instructor.tasks.update', $task)); ?>" method="POST" class="space-y-6">
            ...
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.task_title_required')); ?></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.description')); ?></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.priority')); ?></label>
            ...
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.due_date')); ?></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.course_optional')); ?></label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.lecture_optional')); ?></label>
