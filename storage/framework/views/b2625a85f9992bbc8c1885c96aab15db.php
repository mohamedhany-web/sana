                            ...
                            <?php else: ?>
                                <div class="flex flex-wrap gap-2 mt-1" id="subject-chips">
                                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="sd-chip" data-subject-year="<?php echo e($s->academic_year_id); ?>">
                                            ...
                                            <?php echo e($s->name); ?><?php if($s->academicYear): ?><span class="text-[10px] opacity-70"> · <?php echo e($s->academicYear->name); ?></span><?php endif; ?>
                                        </label>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\student\tutor-lessons\profile.blade.php ENDPATH**/ ?>