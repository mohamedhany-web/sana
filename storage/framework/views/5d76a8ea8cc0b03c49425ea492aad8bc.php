<?php $__env->startSection('title', __('tutor.admin_settings_title')); ?>
<?php $__env->startSection('header', __('tutor.admin_settings_title')); ?>
...
<div class="space-y-6 w-full max-w-none">
    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-6 py-5 bg-slate-50 border-b border-slate-200 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-black text-slate-900"><?php echo e(__('tutor.admin_settings_title')); ?></h2>
                    <p class="text-sm text-slate-600 mt-1">إعدادات حصص الطلاب مع المعلمين: الساعات الافتراضية، الحجز الذاتي، ونافذة المواعيد.</p>
                </div>
            </div>
            <a href="<?php echo e(route('admin.subscriptions.index')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-violet-700 bg-violet-50 border border-violet-200 rounded-xl hover:bg-violet-100 transition-colors">
                    ...
                    <div class="flex items-start justify-between gap-3 mb-3">
                        <div class="min-w-0">
                            ...
                            <p class="text-2xl font-black text-slate-900">
                                <?php echo e($card['value']); ?><?php if($card['suffix']): ?><span class="text-base font-bold text-slate-500 mr-1"><?php echo e($card['suffix']); ?></span><?php endif; ?>
                            </p>
                        </div>
                        <div class="w-11 h-11 rounded-lg <?php echo e($card['bg']); ?> flex items-center justify-center <?php echo e($card['text']); ?> shadow-sm shrink-0">
                            <i class="<?php echo e($card['icon']); ?>"></i>
                        </div>
                    </div>
                    <p class="text-xs text-slate-500"><?php echo e($card['desc']); ?></p>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <section class="xl:col-span-2 rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
            ...
            <form method="post" action="<?php echo e(route('admin.tutor-lessons.settings.update')); ?>" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="rounded-xl border border-violet-100 bg-violet-50/40 p-5">
                    ...
                    <?php $__errorArgs = ['default_student_lesson_hours'];
                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer shrink-0 mt-1">
                            ...
                            <input type="checkbox" name="self_schedule_enabled" value="1" id="self_schedule_enabled"
                                   class="sr-only peer" <?php if($selfSchedule): echo 'checked'; endif; ?>>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" id="default_duration_minutes" name="default_duration_minutes"
                                   min="30" max="180" required value="<?php echo e($duration); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="number" id="slot_step_minutes" name="slot_step_minutes"
                               min="15" max="120" step="15" required value="<?php echo e($slotStep); ?>"
                        ...
                        <?php $__errorArgs = ['slot_step_minutes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-xs text-rose-600 mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-slate-200">
                    ...
                    <a href="<?php echo e(route('admin.tutor-lessons.index')); ?>" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl border border-slate-200 bg-white text-slate-700 text-sm font-semibold hover:bg-slate-50 transition-colors">
                        إلغاء
                    </a>
                </div>
            </form>
        ...
        <aside class="space-y-6">
            <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
                ...
                <div class="p-5 space-y-3">
                    <a href="<?php echo e(route('admin.subscriptions.index')); ?>" class="flex items-center justify-between gap-3 p-4 rounded-xl border border-slate-200 bg-slate-50/50 hover:border-blue-300 hover:bg-blue-50/50 transition-all group">
                    ...
                    <a href="<?php echo e(route('admin.tutor-lessons.index')); ?>" class="flex items-center justify-between gap-3 p-4 rounded-xl border border-slate-200 bg-slate-50/50 hover:border-violet-300 hover:bg-violet-50/50 transition-all group">
                        <div class="flex items-center gap-3 min-w-0">
    ...
    <?php echo $__env->make('admin.tutor-lessons._student-plans-form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\tutor-lessons\settings.blade.php ENDPATH**/ ?>