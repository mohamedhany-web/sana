...
<div class="py-10 md:py-14 px-4">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8 border border-slate-100">
            <form method="GET" action="<?php echo e(route('public.certificates.verify')); ?>" class="flex flex-col sm:flex-row gap-4">
                <input type="text"
                       ...
                       class="flex-1 px-6 py-4 border-2 border-slate-200 rounded-xl bg-white text-slate-900 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-lg outline-none transition-colors">
                <button type="submit"
        ...
        <?php if(isset($certificate)): ?>
            <?php if($certificate && $isValid): ?>
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-emerald-500">
        ...
        <?php elseif(isset($error)): ?>
            <div class="bg-white rounded-2xl shadow-xl p-8 border-2 border-amber-500">
                <div class="text-center">
                    ...
                    <p class="text-amber-700 font-semibold"><?php echo e($error); ?></p>
                </div>
            </div>
        <?php endif; ?>
    </div>
