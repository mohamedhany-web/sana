...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        <a href="<?php echo e(route('student.live-recordings.index')); ?>" class="p-2 rounded-lg hover:bg-slate-100 text-slate-500 transition-colors"><i class="fas fa-arrow-right"></i></a>
        <h1 class="text-xl font-bold text-slate-800 truncate"><?php echo e($liveRecording->title ?? 'تسجيل الجلسة'); ?></h1>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
        ...
        <div class="p-4 border-t border-slate-200 flex flex-wrap items-center gap-4 text-sm text-slate-600">
            ...
            <a href="<?php echo e($url); ?>" target="_blank" rel="noopener" class="text-emerald-600 hover:underline font-medium">
