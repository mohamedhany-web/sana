...
<div class="space-y-4">
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('admin.live-servers.index')); ?>" class="p-2 rounded-lg hover:bg-slate-100 text-slate-500"><i class="fas fa-arrow-right"></i></a>
            <div>
                <h1 class="text-xl font-bold text-slate-800"><i class="fas fa-folder-open text-amber-500 ml-2"></i>تصفح الملفات — <?php echo e($server->name); ?></h1>
        ...
        <a href="<?php echo e(route('admin.live-servers.edit', $server)); ?>" class="px-4 py-2 rounded-xl bg-slate-200 text-slate-700 font-medium hover:bg-slate-300"><i class="fas fa-cog ml-1"></i> إعدادات السيرفر</a>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b border-slate-100 hover:bg-slate-50">
                    <td class="py-2 px-4">
                        <a href="<?php echo e(route('admin.live-servers.ssh-browse', [$server, 'path' => $dir['path']])); ?>" class="flex items-center gap-2 text-slate-800 hover:text-cyan-500">
                ...
                <tr class="border-b border-slate-100 hover:bg-slate-50">
                    <td class="py-2 px-4">
                        <a href="<?php echo e(route('admin.live-servers.ssh-file', [$server, 'path' => $file['path']])); ?>" class="flex items-center gap-2 text-slate-800 hover:text-cyan-500">
