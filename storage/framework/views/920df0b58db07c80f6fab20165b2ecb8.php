                ...
                <div class="bg-white border border-gray-100 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col">
                    <div class="relative h-48 bg-gradient-to-br from-sky-500 to-indigo-600 flex items-center justify-center">
                        <?php if(!empty($course->thumbnail)): ?>
                            <img src="<?php echo e(public_storage_url($course->thumbnail)); ?>" alt="<?php echo e($course->title); ?>" class="absolute inset-0 w-full h-full object-cover opacity-90">
                        <?php else: ?>
                            ...
                            <?php if(!$course->is_free && $course->effectivePurchasePrice() > 0): ?>
                                <?php if($course->hasPromotionalPrice()): ?>
                                    <span class="inline-flex flex-col items-end gap-0.5 px-3 py-1.5 rounded-lg bg-emerald-500 text-white text-xs font-bold shadow-lg tabular-nums">
                                        <span class="line-through opacity-85 text-[10px]"><?php echo e(number_format($course->listPriceAmount(), 0)); ?> <?php echo e(__('public.currency')); ?></span>
                                        <span class="text-sm"><?php echo e(number_format($course->effectivePurchasePrice(), 0)); ?> <?php echo e(__('public.currency')); ?></span>
                                    </span>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\student\subjects\courses.blade.php ENDPATH**/ ?>