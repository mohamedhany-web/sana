<?php $__env->startSection('title', 'طلبات السحب - ' . config('app.name', 'Sana')); ?>
        ...
        <div class="rounded-xl bg-white border border-slate-200 shadow-md p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-right">
                    ...
                    <p class="text-xl font-black text-slate-900"><?php echo e(number_format($stats['completed'], 2)); ?> <?php echo e(__('public.currency')); ?></p>
                </div>
            </div>
        </div>
    </section>
                ...
                <tbody class="bg-white divide-y divide-slate-200">
                    <?php $__empty_1 = true; $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="font-bold text-slate-900 text-lg"><?php echo e(number_format($withdrawal->amount ?? 0, 2)); ?> <?php echo e(__('public.currency')); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <?php
                                    $paymentMethodBadges = [
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\withdrawals\index.blade.php ENDPATH**/ ?>