                            ...
                            <div class="flex-1">
                                <div class="flex items-center mb-2">
                                    ...
                                    <span class="mr-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($template->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                        <?php echo e($template->is_active ? __('???') : __('????')); ?>
                                ...
                                <div class="flex items-center text-xs text-gray-500">
                                    <span><?php echo e(__('?????')); ?>: <?php echo e($template->type); ?></span>
                                    <span class="mx-2">•</span>
                                    <span><?php echo e(__('??????')); ?>: <?php echo e($template->creator->name); ?></span>
                                    <span class="mx-2">•</span>
                            ...
                            <div class="flex space-x-1 space-x-reverse">
                                ...
                                <form action="<?php echo e(route('admin.messages.templates.destroy', $template)); ?>" method="POST" class="inline">
                                    ...
                                    <button type="submit" class="text-red-600 hover:text-red-800 p-2"
                                            onclick="return confirm('<?php echo e(__('?? ???? ??? ??? ???????')); ?>')">
                ...
                <form action="<?php echo e(route('admin.messages.templates.store')); ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="type" required
                            ...
                            <option value="student_report"><?php echo e(__('????? ????')); ?></option>
                            <option value="exam_result"><?php echo e(__('????? ??????')); ?></option>
                            <option value="general_announcement"><?php echo e(__('????? ???')); ?></option>
                            <option value="parent_report"><?php echo e(__('????? ???? ?????')); ?></option>
                            <option value="course_reminder"><?php echo e(__('????? ???????')); ?></option>
                            <option value="welcome_message"><?php echo e(__('????? ?????')); ?></option>
                        </select>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="content" rows="8" required
                                  ...
                                  placeholder="<?php echo e(__('???? ????? ??????... ????? ??????? ????????? ??? {student_name}')); ?>"></textarea>
                        <div class="mt-2 text-xs text-gray-500">
                            <?php echo e(__('????? ??? ????????? ??????: {student_name}, {courses_count}, {avg_score}, {month_name}, {date}')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\messages\templates.blade.php ENDPATH**/ ?>