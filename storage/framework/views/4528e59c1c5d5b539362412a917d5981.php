                ...
                <table class="mt-4 w-full text-sm text-slate-600">
                    <tbody class="divide-y divide-slate-200">
                        <tr class="flex items-center justify-between py-3">
                            <td>المبلغ الفرعي</td>
                            <td class="font-semibold text-slate-900"><?php echo e(number_format($invoice->subtotal, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                        </tr>
                        <?php if($invoice->tax_amount > 0): ?>
                            <tr class="flex items-center justify-between py-3">
                                <td>الضريبة</td>
                                <td class="font-semibold text-slate-900"><?php echo e(number_format($invoice->tax_amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if($invoice->discount_amount > 0): ?>
                            <tr class="flex items-center justify-between py-3">
                                <td>الخصم</td>
                                <td class="font-semibold text-rose-600">-<?php echo e(number_format($invoice->discount_amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                            </tr>
                        <?php endif; ?>
                        <tr class="flex items-center justify-between py-3 text-lg font-bold text-slate-900">
                            <td>الإجمالي المستحق</td>
                            <td class="text-sky-600"><?php echo e(number_format($invoice->total_amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                        ...
                        <tbody class="divide-y divide-slate-200">
                            <?php $__currentLoopData = $invoice->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="grid grid-cols-3 items-center gap-4 py-3">
                                    ...
                                    <td class="text-left font-semibold text-slate-900"><?php echo e(number_format($payment->amount, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                                </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\invoices\show.blade.php ENDPATH**/ ?>