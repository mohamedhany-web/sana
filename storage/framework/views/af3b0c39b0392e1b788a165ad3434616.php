...
<?php $__env->startSection('title', 'برامج الإحالات - ' . config('app.name', 'Sana')); ?>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-xs text-gray-500">حد أقصى: <?php echo e(number_format($program->maximum_discount, 2)); ?> <?php echo e(__('public.currency')); ?></div>
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <span class="text-sm font-medium text-gray-900">
                                ...
                                <?php else: ?>
                                    <?php echo e(number_format($program->referrer_reward_value, 2)); ?> <?php echo e(__('public.currency')); ?>
