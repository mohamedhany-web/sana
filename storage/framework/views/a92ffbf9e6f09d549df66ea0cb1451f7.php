        ...
        <div class="flex flex-col lg:flex-row gap-10 lg:gap-8 items-center">
            ...
            <div class="relative w-full lg:w-1/2 reveal">
                <div class="relative mx-auto max-w-md lg:max-w-none pb-8 lg:pb-0">
                    ...
                    <img src="<?php echo e($photos['hero']); ?>" alt="طالب يتعلّم أونلاين مع معلم" class="relative z-10 w-full max-w-lg mx-auto rounded-[2rem] object-cover shadow-2xl" width="600" height="700" loading="eager">
