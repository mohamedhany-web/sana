                            ...
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <?php if($payment->status === 'paid' && $payment->transfer_receipt_path): ?>
                                        <a href="<?php echo e(public_storage_url($payment->transfer_receipt_path)); ?>" target="_blank" class="block text-xs text-blue-600 hover:underline mt-1"><i class="fas fa-receipt mr-1"></i>الإيصال</a>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
