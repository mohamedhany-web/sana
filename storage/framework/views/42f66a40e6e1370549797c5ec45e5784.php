...
<div class="space-y-6 w-full max-w-full" x-data="instructorProfilePage(<?php echo \Illuminate\Support\Js::from($initialTab)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($defaultAvatarUrl)->toHtml() ?>)">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div class="rounded-2xl p-4 sm:p-5 bg-white border border-slate-200 shadow-sm">
            <p class="text-[11px] font-bold text-slate-500 uppercase tracking-wide m-0 mb-1"><?php echo e(__('instructor.my_courses')); ?></p>
            <p class="text-2xl font-black text-slate-800 m-0 tabular-nums"><?php echo e($myCoursesCount); ?></p>
        </div>
        <div class="rounded-2xl p-4 sm:p-5 bg-white border border-slate-200 shadow-sm">
            <p class="text-[11px] font-bold text-slate-500 uppercase tracking-wide m-0 mb-1"><?php echo e(__('instructor.total_students')); ?></p>
            <p class="text-2xl font-black text-slate-800 m-0 tabular-nums"><?php echo e($totalStudents); ?></p>
        </div>
        <div class="rounded-2xl p-4 sm:p-5 bg-white border border-slate-200 shadow-sm">
            <p class="text-[11px] font-bold text-slate-500 uppercase tracking-wide m-0 mb-1"><?php echo e(__('instructor.join_date')); ?></p>
            <p class="text-sm font-bold text-slate-800 m-0 leading-snug"><?php echo e($memberSince); ?></p>
        </div>
        <div class="rounded-2xl p-4 sm:p-5 bg-white border border-slate-200 shadow-sm">
            <p class="text-[11px] font-bold text-slate-500 uppercase tracking-wide m-0 mb-1"><?php echo e(__('common.status')); ?></p>
            <p class="text-sm font-bold m-0 flex items-center gap-2 <?php echo e($user->is_active ? 'text-emerald-600' : 'text-rose-600'); ?>">
    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5 sm:p-6">
        <div class="flex flex-col md:flex-row md:items-center gap-5 md:gap-6">
            ...
            <div class="flex-1 min-w-0 text-center md:text-right">
                ...
                <h2 class="text-xl sm:text-2xl font-black text-slate-900 m-0 break-words"><?php echo e($user->name); ?></h2>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <form method="POST" action="<?php echo e(route('instructor.profile.update')); ?>" enctype="multipart/form-data" class="p-5 sm:p-6 space-y-6">
                    ...
                    <div x-show="tab === 'info'" x-cloak class="space-y-4">
                        <div>
                            <h3 class="text-base font-bold text-slate-900 m-0"><?php echo e(__('instructor.account_info')); ?></h3>
                            <p class="text-xs text-slate-500 mt-1 m-0"><?php echo e(__('instructor.update_data_subtitle')); ?></p>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="ip-name" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.full_name')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="ip-phone" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.phone')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                <label for="ip-email" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.email_optional')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                <label for="ip-bio" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.bio_optional')); ?></label>
                                <textarea id="ip-bio" name="bio" rows="4" placeholder="<?php echo e(__('instructor.bio_placeholder_short')); ?>"
                                          class="w-full px-4 py-2.5 border border-slate-200 rounded-xl bg-slate-50 text-slate-800 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20"><?php echo e(old('bio', $user->bio)); ?></textarea>
                                <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div x-show="tab === 'photo'" x-cloak class="space-y-4">
                        <div>
                            <h3 class="text-base font-bold text-slate-900 m-0"><?php echo e(__('instructor.profile_image')); ?></h3>
                            <p class="text-xs text-slate-500 mt-1 m-0"><?php echo e(__('instructor.choose_image_label')); ?></p>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div x-show="tab === 'security'" x-cloak class="space-y-4">
                        <div>
                            <h3 class="text-base font-bold text-slate-900 m-0"><?php echo e(__('instructor.change_password')); ?></h3>
                            <p class="text-xs text-slate-500 mt-1 m-0"><?php echo e(__('instructor.leave_empty_if_no_change')); ?></p>
                        </div>
                        <div class="space-y-4">
                            <div>
                                <label for="ip-current-pw" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.current_password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label for="ip-new-pw" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.new_password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    <label for="ip-confirm-pw" class="block text-sm font-semibold text-slate-700 mb-2"><?php echo e(__('instructor.confirm_password')); ?></label>
                    ...
                    <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3 pt-4 border-t border-slate-200">
                        <p class="text-xs text-slate-500 m-0"><?php echo e(__('instructor.membership_number')); ?> <?php echo e($membershipId); ?></p>
        ...
        <aside class="lg:col-span-4 space-y-4">
            <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5 space-y-2">
                ...
                <a href="<?php echo e(route('instructor.personal-branding.edit')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors no-underline text-inherit group">
                    ...
                    <span class="flex-1 min-w-0">
                        <span class="block text-sm font-semibold text-slate-800"><?php echo e(__('instructor.personal_branding')); ?></span>
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('instructor.courses.index')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors no-underline text-inherit group">
                    ...
                    <span class="flex-1 text-sm font-semibold text-slate-800"><?php echo e(__('instructor.my_courses')); ?></span>
                    <i class="fas fa-chevron-left text-slate-300 text-xs"></i>
                </a>
                <?php if(Route::has('instructor.classroom.index') && $user->hasSubscriptionFeature('classroom_access')): ?>
                <a href="<?php echo e(route('instructor.classroom.index')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors no-underline text-inherit group">
                    ...
                    <span class="flex-1 text-sm font-semibold text-slate-800"><?php echo e(__('platform.classroom')); ?></span>
                    <i class="fas fa-chevron-left text-slate-300 text-xs"></i>
                </a>
                <?php endif; ?>
                <a href="<?php echo e(route('settings')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors no-underline text-inherit group">
                    ...
                    <span class="flex-1 text-sm font-semibold text-slate-800"><?php echo e(__('instructor.settings')); ?></span>
                    <i class="fas fa-chevron-left text-slate-300 text-xs"></i>
                </a>
            </div>

            <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5">
                <h3 class="text-sm font-bold text-slate-900 m-0 mb-3"><?php echo e(__('instructor.tips_for_instructor')); ?></h3>
                <ul class="space-y-3 m-0 p-0 list-none text-sm text-slate-600">
                    <li class="flex gap-2">
                        ...
                        <span><strong class="text-slate-800"><?php echo e(__('instructor.update_bio')); ?></strong> — <?php echo e(__('instructor.add_bio_for_students')); ?></span>
                    </li>
                    <li class="flex gap-2">
