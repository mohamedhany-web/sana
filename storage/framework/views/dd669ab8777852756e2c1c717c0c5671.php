...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
            <div class="text-sm text-slate-500 dark:text-slate-400">مبالغ غير مسوّاة (<?php echo e(__('public.currency')); ?>)</div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                        ...
                        <td class="px-4 py-3 font-mono font-semibold text-slate-800 dark:text-white"><?php echo e(number_format($row->commission_amount_egp, 2)); ?> <?php echo e(__('public.currency')); ?></td>
                        <td class="px-4 py-3">
