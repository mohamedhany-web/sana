...
<body class="mx-meeting-body">
    <header class="mx-meeting-room-header h-[72px]">
        <div class="flex items-center gap-3 min-w-0">
            <a href="<?php echo e(route('instructor.live-sessions.index')); ?>" class="mx-meeting-brand-link shrink-0">
            ...
            <div class="flex items-center gap-2 min-w-0">
                ...
                <span class="mx-meeting-code-chip hidden sm:inline"><?php echo e($liveSession->room_name); ?></span>
            </div>
