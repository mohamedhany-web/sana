<?php $__env->startSection('title', 'تعديل رأي - ' . ($platformName ?? config('brand.name', config('app.name')))); ?>
...
<div class="admin-dashboard admin-list-page admin-form-page admin-form-page--full w-full max-w-none space-y-7" x-data="{ type: '<?php echo e($oldType); ?>' }">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-hero','data' => ['title' => 'تعديل رأي','subtitle' => ''.e($t->author_name ? 'صاحب الرأي: ' . $t->author_name : 'بدون اسم معروض').' — '.e($t->is_active ? 'نشط' : 'معطل').'','icon' => 'fas fa-pen']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'تعديل رأي','subtitle' => ''.e($t->author_name ? 'صاحب الرأي: ' . $t->author_name : 'بدون اسم معروض').' — '.e($t->is_active ? 'نشط' : 'معطل').'','icon' => 'fas fa-pen']); ?>
...
<?php endif; ?>
    ...
    <div class="admin-panel w-full">
        ...
        <div class="admin-panel__body">
            <form action="<?php echo e(route('admin.site-testimonials.update', $t)); ?>" method="POST" enctype="multipart/form-data" class="admin-form-layout space-y-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-5">
                        <template x-if="type === 'text'">
                            <div class="admin-field">
                                ...
                                <textarea name="body" rows="8" class="admin-textarea admin-textarea--tall"><?php echo e(old('body', $t->body)); ?></textarea>
                                ...
                                <?php if($t->publicImageUrl()): ?>
                                    <div class="admin-field">
                                        ...
                                        <div class="rounded-xl border border-slate-200 overflow-hidden max-w-md bg-slate-50">
                                            <img src="<?php echo e($t->publicImageUrl()); ?>" alt="" class="w-full h-auto max-h-56 object-contain">
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <div class="admin-field">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="admin-field">
                                    ...
                                    <textarea name="body" rows="3" class="admin-textarea"><?php echo e(old('body', $t->body)); ?></textarea>
                                </div>
                            </div>
                        </template>
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div class="admin-field">
                                ...
                                <input type="text" name="author_name" value="<?php echo e(old('author_name', $t->author_name)); ?>" maxlength="190" class="admin-input">
                            </div>
                            <div class="admin-field">
                                <label>المسمى (اختياري)</label>
                                <input type="text" name="role_label" value="<?php echo e(old('role_label', $t->role_label)); ?>" maxlength="190" class="admin-input">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-5">
                        <div class="admin-form-side-card">
                            <div class="admin-field">
                                ...
                                <input type="number" name="sort_order" value="<?php echo e(old('sort_order', $t->sort_order)); ?>" min="0" class="admin-input">
                            </div>
                            <div class="admin-field pt-1 space-y-3">
                                <input type="hidden" name="is_active" value="0">
                                <input type="hidden" name="is_featured" value="0">
                                <label class="admin-checkbox-row">
                                    <input type="checkbox" name="is_active" value="1" <?php if(old('is_active', $t->is_active ? '1' : '0') === '1'): echo 'checked'; endif; ?>>
                                    <span>نشط — يظهر في الموقع</span>
                                </label>
                                <label class="admin-checkbox-row">
                                    <input type="checkbox" name="is_featured" value="1" <?php if(old('is_featured', $t->is_featured ? '1' : '0') === '1'): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\site-testimonials\edit.blade.php ENDPATH**/ ?>