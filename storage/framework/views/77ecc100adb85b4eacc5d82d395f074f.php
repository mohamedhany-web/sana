    ...
    <div class="bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col" @click.stop>
        ...
        <div class="p-6 overflow-y-auto flex-1">
            ...
            <div class="space-y-3 max-h-80 overflow-y-auto">
                <?php $__currentLoopData = $availableQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form action="<?php echo e(route('instructor.exams.questions.add-from-bank', $exam)); ?>" method="POST" class="flex items-center gap-3 p-4 rounded-xl border border-slate-200 hover:border-sky-200 hover:bg-sky-50 transition-colors">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="question_id" value="<?php echo e($question->id); ?>">
                        ...
                        <input type="number" name="marks" value="<?php echo e($question->points ?? 1); ?>" min="0.5" step="0.5" required class="w-16 px-2 py-1.5 border border-slate-200 rounded-lg text-sm text-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\instructor\exams\manage-questions.blade.php ENDPATH**/ ?>