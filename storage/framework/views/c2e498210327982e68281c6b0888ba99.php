                    ...
                    <div class="sanua-settings-list">
                        ...
                        <?php if(Route::has('student.support.index')): ?>
                            <div class="sanua-setting-row">
                                ...
                                <a href="<?php echo e(route('student.support.index')); ?>" class="sanua-btn sanua-btn--purple" style="padding:8px 14px;font-size:0.75rem;">
                                    <i class="fas fa-headset"></i> فتح تذكرة
                                </a>
                            </div>
                        <?php elseif(Route::has('public.contact')): ?>
                            <div class="sanua-setting-row">
                                <div class="sanua-setting-row__text">
                                    <p class="sanua-setting-row__title">الدعم الفني</p>
                                    <p class="sanua-setting-row__desc">لطلبات حذف الحساب أو تصدير البيانات تواصل معنا</p>
                                </div>
                                <a href="<?php echo e(route('public.contact')); ?>" class="sanua-btn sanua-btn--purple" style="padding:8px 14px;font-size:0.75rem;">
