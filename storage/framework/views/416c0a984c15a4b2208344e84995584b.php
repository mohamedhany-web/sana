                ...
                <div class="space-y-8">
                    ...
                    <div class="card-hover p-6 rounded-xl bg-gradient-to-br from-sky-50 to-sky-100 border-r-4 border-sky-500">
                        ...
                        <p class="text-gray-700 leading-relaxed mb-4">
                            ????? ??? ????????? ?? ???? ??????? ???? ??? ???? 
                            <a href="<?php echo e(route('public.contact')); ?>" class="text-sky-600 hover:underline font-semibold">????? ????</a> 
                            ?? ????? ???? ???????? ??? ??? ???????.
                        </p>
                    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\public\refund.blade.php ENDPATH**/ ?>