...
<div class="space-y-6">
    <div class="flex items-center gap-3">
        <a href="<?php echo e(route('admin.live-recordings.index')); ?>" class="p-2 rounded-lg hover:bg-slate-100 text-slate-500 transition-colors"><i class="fas fa-arrow-right"></i></a>
    ...
    <div class="bg-amber-50 rounded-xl border border-amber-200 p-4 text-sm text-amber-800">
        ...
        <code class="block bg-white p-2 rounded text-xs break-all">curl -X POST <?php echo e(url('/api/live-recordings/register')); ?> \<br>
  ...
  -d '{"session_id": 1, "file_path": "live-recordings/session-1/rec.mp4", "duration_seconds": 3600, "file_size": 104857600}'</code>
    ...
    <form method="POST" action="<?php echo e(route('admin.live-recordings.store')); ?>" class="bg-white rounded-xl border border-slate-200 p-6 space-y-5">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="title" value="<?php echo e(old('title')); ?>" placeholder="اختياري — يُستخدم عنوان الجلسة إن تُرك فارغاً" class="w-full rounded-lg border-slate-300">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" name="file_path" value="<?php echo e(old('file_path')); ?>" required placeholder="مثال: live-recordings/session-1/2025-03-16-rec.mp4" class="w-full rounded-lg border-slate-300">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="url" name="external_url" value="<?php echo e(old('external_url')); ?>" placeholder="https://..." class="w-full rounded-lg border-slate-300">
            ...
            <div>
                ...
                <input type="number" name="duration_seconds" value="<?php echo e(old('duration_seconds', 0)); ?>" min="0" class="w-full rounded-lg border-slate-300">
            </div>
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-1">حجم الملف (بايت)</label>
                <input type="number" name="file_size" value="<?php echo e(old('file_size', 0)); ?>" min="0" class="w-full rounded-lg border-slate-300">
            </div>
            <div class="md:col-span-2">
        ...
        <div class="flex gap-3 pt-2">
            ...
            <a href="<?php echo e(route('admin.live-recordings.index')); ?>" class="px-6 py-2.5 bg-slate-200 text-slate-700 rounded-xl font-medium hover:bg-slate-300 transition-colors">إلغاء</a>
        </div>
    </form>
</div>
