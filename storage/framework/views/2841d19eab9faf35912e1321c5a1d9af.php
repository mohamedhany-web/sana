                ...
                <header class="app-header flex items-center justify-between px-4 md:px-6 flex-shrink-0 sticky top-0 z-30">
                    ...
                    <div class="flex items-center gap-2">
                        <div x-data="themeManager()" x-init="init()">
                            <button @click="toggle()" type="button" class="h-btn" :title="dark ? '<?php echo e($appRtl ? 'الوضع النهاري' : 'Light mode'); ?>' : '<?php echo e($appRtl ? 'الوضع الليلي' : 'Dark mode'); ?>'">
                                ...
                                <?php if($navRecentNotifications->isNotEmpty()): ?>
                                    <div class="max-h-96 overflow-y-auto">
                                        <?php $__currentLoopData = $navRecentNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <a href="<?php echo e($notificationUrl); ?>" class="block px-4 py-3 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
            ...
            <main class="flex-1 overflow-auto bg-surface-50 dark:bg-navy-950">
                <div class="p-4 md:p-6 lg:p-8 w-full max-w-full">
                    <?php if(session('success')): ?>
                        <div class="mb-5 <?php echo e(($useInstructorShell ?? false) ? 'ins-flash' : 'flex items-center gap-3'); ?> bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 px-4 py-3 rounded-xl text-sm">
                    ...
                    <?php if(session('error')): ?>
                        <div class="mb-5 <?php echo e(($useInstructorShell ?? false) ? 'ins-flash' : 'flex items-center gap-3'); ?> bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 px-4 py-3 rounded-xl text-sm">
                    ...
                    <?php endif; ?>
                    <?php if(session('info')): ?>
                        <div class="mb-5 <?php echo e(($useInstructorShell ?? false) ? 'ins-flash' : 'flex items-center gap-3'); ?> bg-sky-50 dark:bg-sky-900/20 border border-sky-200 dark:border-sky-800 text-sky-800 dark:text-sky-200 px-4 py-3 rounded-xl text-sm">
