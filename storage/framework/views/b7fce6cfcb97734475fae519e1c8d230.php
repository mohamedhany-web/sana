        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-1">
                    العملة الأساسية لكل الأسعار في هذه الصفحة هي <span class="font-semibold"><?php echo e(__('public.currency_name')); ?> (<?php echo e(__('public.currency')); ?>)</span>.
                </p>
                ...
                <?php $__currentLoopData = $plansMeta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="rounded-2xl border border-slate-200 shadow-sm overflow-hidden bg-white flex flex-col">
                        ...
                        <div class="p-5 space-y-4 flex-1 flex flex-col">
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-slate-700 mb-1">السعر (<?php echo e(__('public.currency_name')); ?>)</label>
                                <div class="relative">
                                    <input type="number"
                                           step="0.01"
                                           min="0"
                                    ...
                                    <span class="absolute inset-y-0 left-3 flex items-center text-xs font-semibold text-slate-500"><?php echo e(__('public.currency')); ?></span>
                                </div>
                            </div>
                            <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sana\resources\views\admin\teacher-features\index.blade.php ENDPATH**/ ?>