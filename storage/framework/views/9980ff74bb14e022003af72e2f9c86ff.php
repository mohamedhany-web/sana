    ...
    <div class="rounded-2xl p-5 sm:p-6 bg-white border border-slate-200 shadow-sm">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('instructor.exams.questions.manage', $exam)); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-violet-600 hover:bg-violet-600 text-white rounded-xl font-semibold transition-colors">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="text-slate-800 font-semibold"><?php echo e($exam->advancedCourse->title ?? '—'); ?></div>
        ...
        <div class="p-6">
            <div x-show="activeTab === 'questions'">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('instructor.exams.questions.manage', $exam)); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-violet-600 hover:bg-violet-600 text-white rounded-xl font-semibold text-sm transition-colors">
                        <i class="fas fa-cogs"></i> <?php echo e(__('instructor.manage_questions')); ?>
