...
<div class="sd-page space-y-6 pb-8">
    ...
    <div class="rounded-2xl border border-[#f5c7e8] dark:border-indigo-900/50 bg-gradient-to-l from-[#FFE5F7]/80 to-white dark:from-slate-800/90 dark:to-slate-900/90 px-5 py-4 flex flex-wrap items-center justify-between gap-3">
        <div class="flex items-center gap-3 min-w-0">
            ...
            <div>
                <p class="font-bold text-slate-800 dark:text-white"><?php echo e($activeSubscription->plan_name); ?></p>
    ...
    <div class="sd-hero">
        <div class="sd-hero-main relative z-[1]">
            <div class="flex flex-col sm:flex-row sm:items-center gap-5 justify-between">
                <div class="min-w-0">
                    <p class="text-xs font-bold text-[#283593] dark:text-indigo-300 mb-2"><?php echo e(__('student.dashboard_overview_today')); ?></p>
                    ...
                    <p class="text-slate-600 dark:text-slate-400 text-sm mt-2 max-w-lg leading-relaxed"><?php echo e(__('student.dashboard_subtitle')); ?></p>
                </div>
                <div class="flex items-center gap-4 flex-shrink-0">
                    <div class="sd-ring relative">
                        ...
                        <span class="absolute inset-0 flex items-center justify-center font-black text-lg text-[#283593] dark:text-indigo-300"><?php echo e($progress); ?>%</span>
                    </div>
                    <div class="hidden sm:block text-right">
                        <p class="text-sm font-bold text-slate-700 dark:text-slate-200"><?php echo e(__('student.dashboard_general_progress')); ?></p>
                        <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e(__('student.from_course_completion')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="sd-motivation">
            ...
            <p class="font-bold text-slate-800 dark:text-white text-sm leading-relaxed"><?php echo e(__('student.dashboard_motivation')); ?></p>
            <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'student.view.courses')): ?>
            <a href="<?php echo e(route('public.courses')); ?>" class="text-xs font-bold text-[#283593] dark:text-indigo-400 hover:underline"><?php echo e(__('student.explore_courses')); ?> →</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div>
        <h2 class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-3"><?php echo e(__('student.dashboard_progress_summary')); ?></h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="sd-kpi">
                ...
                <p class="text-2xl font-black text-slate-800 dark:text-white tabular-nums"><?php echo e((int) $stats['total_learning_hours']); ?></p>
                <p class="text-xs font-bold text-slate-600 dark:text-slate-300 mt-0.5"><?php echo e(__('student.dashboard_learning_hours')); ?></p>
                <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-1"><?php echo e(__('student.dashboard_learning_hours_hint')); ?></p>
            </div>
            <a href="<?php echo e(route('student.certificates.index')); ?>" class="sd-kpi block no-underline text-inherit">
                ...
                <p class="text-2xl font-black text-slate-800 dark:text-white tabular-nums"><?php echo e($stats['completed_courses']); ?></p>
                <p class="text-xs font-bold text-slate-600 dark:text-slate-300 mt-0.5"><?php echo e(__('student.dashboard_completed_this_month')); ?></p>
            </a>
            <a href="<?php echo e(route('student.exams.index')); ?>" class="sd-kpi block no-underline text-inherit">
                ...
                <p class="text-xs font-bold text-slate-600 dark:text-slate-300 mt-0.5"><?php echo e(__('student.dashboard_exam_average')); ?></p>
                <?php if($stats['completed_exams'] > 0): ?>
                <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-1"><?php echo e(__('student.dashboard_exams_taken', ['count' => $stats['completed_exams']])); ?></p>
                <?php endif; ?>
            </a>
            ...
            <a href="<?php echo e(route('student.achievements.index')); ?>" class="sd-kpi block no-underline text-inherit">
                ...
                <p class="text-2xl font-black text-slate-800 dark:text-white tabular-nums"><?php echo e($achievementsCount); ?></p>
                <p class="text-xs font-bold text-slate-600 dark:text-slate-300 mt-0.5"><?php echo e(__('student.dashboard_achievements')); ?></p>
                <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-1"><?php echo e(__('student.dashboard_achievements_hint')); ?></p>
            </a>
            <?php else: ?>
            <div class="sd-kpi">
                <div class="flex items-start justify-between gap-2 mb-3">
    ...
    <div class="sd-panel">
        <div class="sd-panel-head">
            <h2 class="font-heading font-bold text-slate-800 dark:text-white"><?php echo e(__('student.dashboard_current_courses')); ?></h2>
            <a href="<?php echo e(route('my-courses.index')); ?>" class="text-sm font-bold text-[#283593] dark:text-indigo-400 hover:underline">
            ...
            <div id="sd-courses-track" class="sd-courses-track" dir="ltr">
                <?php $__currentLoopData = $activeCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <article class="sd-course-card" dir="rtl">
                        ...
                        <h3 class="font-bold text-slate-800 dark:text-white text-sm leading-snug mb-2 line-clamp-2 min-h-[2.5rem]"><?php echo e($course->title); ?></h3>
                        ...
                        <div class="flex items-center gap-2 mb-3">
                            ...
                            <span class="text-xs font-bold text-slate-700 dark:text-slate-200 tabular-nums"><?php echo e($prog); ?>%</span>
                        </div>
        ...
        <div class="text-center py-14 px-4">
            ...
            <p class="font-bold text-slate-700 dark:text-slate-200"><?php echo e(__('student.no_active_courses')); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div class="lg:col-span-5 sd-panel min-w-0">
            <div class="sd-panel-head">
                <h2 class="font-heading font-bold text-slate-800 dark:text-white"><?php echo e(__('student.dashboard_calendar')); ?></h2>
                <?php if(Route::has('calendar')): ?>
                <a href="<?php echo e(route('calendar')); ?>" class="text-xs font-bold text-[#283593] dark:text-indigo-400"><?php echo e(__('student.view_all')); ?></a>
                <?php endif; ?>
            </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $upcomingCalendar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <?php endif; ?>
                        ...
                        <div class="min-w-0 flex-1">
                            <p class="font-bold text-sm text-slate-800 dark:text-slate-100 truncate"><?php echo e($event['title']); ?></p>
                            <?php if($event['subtitle']): ?>
                            <p class="text-xs text-slate-500 dark:text-slate-400 truncate"><?php echo e($event['subtitle']); ?></p>
                            <?php endif; ?>
        ...
        <div class="lg:col-span-7 sd-panel min-w-0">
            <div class="sd-panel-head">
                <h2 class="font-heading font-bold text-slate-800 dark:text-white"><?php echo e(__('student.dashboard_recent_activity')); ?></h2>
            </div>
            <div class="px-4 py-2">
                <?php $__empty_1 = true; $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <a href="<?php echo e($activity['url']); ?>" class="sd-activity-item block no-underline text-inherit hover:bg-slate-50/80 dark:hover:bg-slate-800/40 rounded-xl px-2 -mx-2">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                        ...
                        <div class="min-w-0 flex-1">
                            <p class="text-sm font-semibold text-slate-800 dark:text-slate-100 leading-relaxed"><?php echo e($activity['text']); ?></p>
                            <div class="flex items-center gap-2 mt-1 flex-wrap">
                                <span class="text-[11px] text-slate-500 dark:text-slate-400"><?php echo e($dashboardService->humanActivityTime($activity['at'])); ?></span>
                                <?php if(!empty($activity['meta'])): ?>
                                <span class="text-[11px] font-bold text-emerald-600 dark:text-emerald-400"><?php echo e($activity['meta']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php if(!empty($activity['url'])): ?>
