        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <label class="text-sm font-medium text-slate-700 flex-1"><?php echo e($setting->label ?? $setting->key); ?></label>
                    <?php if($setting->type === 'boolean'): ?>
                        <select name="settings[<?php echo e($index); ?>][value]" class="w-28 rounded-lg border-slate-300 text-sm">
                    ...
                    <?php elseif($setting->type === 'integer'): ?>
                        <input type="number" name="settings[<?php echo e($index); ?>][value]" value="<?php echo e($setting->value); ?>" class="w-32 rounded-lg border-slate-300 text-sm">
                    <?php else: ?>
                        <input type="text" name="settings[<?php echo e($index); ?>][value]" value="<?php echo e($setting->value); ?>" class="w-64 rounded-lg border-slate-300 text-sm" placeholder="—">
                    <?php endif; ?>
                </div>
                <?php $index++; ?>
