<?php $__env->startSection('title', 'إنشاء برنامج إحالة'); ?>
...
<div class="space-y-6">
    <div class="flex flex-wrap items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900 font-heading"><i class="fas fa-gift text-emerald-600 ml-2"></i>برنامج إحالة جديد</h1>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-300 bg-white text-gray-900 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all"><?php echo e(old('description')); ?></textarea>
                </div>
