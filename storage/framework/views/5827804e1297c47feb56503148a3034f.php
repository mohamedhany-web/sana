...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1">الحد الأدنى للطلب (<?php echo e(__('public.currency')); ?>)</label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1">الحد الأقصى للخصم (<?php echo e(__('public.currency')); ?>)</label>
