        ...
        <div class="p-4">
            <form method="GET" action="<?php echo e(route('admin.payments.index')); ?>" id="filterForm" class="flex flex-col gap-3 sm:flex-row sm:items-end sm:flex-wrap">
                <div class="flex-1 min-w-[180px]">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" maxlength="255" placeholder="رقم الدفعة، اسم العميل، هاتف، مرجع" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" />
                </div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                ...
                                <div class="flex-1 min-w-0 space-y-1">
                                    ...
                                    <div class="flex flex-wrap items-center gap-3 text-xs text-slate-600">
                                        <span><i class="fas fa-coins text-emerald-500 ml-0.5"></i> <strong><?php echo e(number_format($payment->amount, 2)); ?></strong> <?php echo e(__('public.currency')); ?></span>
