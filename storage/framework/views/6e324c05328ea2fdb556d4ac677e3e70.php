        ...
        <div class="edu-courses-inner">
            <div class="max-w-3xl mx-auto text-center reveal">
                <nav class="edu-breadcrumb justify-center mb-4" aria-label="مسار التنقل">
                    ...
                    <span class="text-slate-800 font-semibold"><?php echo e(__('public.terms_page_title')); ?></span>
                </nav>
                <span class="edu-badge mb-4"><i class="fas fa-gavel"></i> <?php echo e(__('public.terms_page_title')); ?></span>
                ...
                <p class="text-slate-600 leading-8 mt-3 text-sm lg:text-base max-w-2xl mx-auto">
                    <?php echo e($pub('legal_terms_hero_sub')); ?>
                ...
                <div class="edu-hero-actions mt-6 justify-center">
                    ...
                    <a href="<?php echo e(route('public.privacy')); ?>" class="edu-btn-outline">
                        <i class="fas fa-shield-halved"></i>
                        <?php echo e(__('public.privacy_page_title')); ?>
        ...
        <div class="edu-courses-inner max-w-4xl mx-auto">
            <div class="edu-card p-6 sm:p-8 flex flex-col sm:flex-row gap-5 items-start reveal">
                ...
                <p class="text-slate-700 leading-[1.9] text-sm lg:text-base flex-1">
                    <?php echo nl2br(e($pub('legal_terms_intro'))); ?>
    ...
    <div class="edu-container-full">
        <div class="edu-courses-inner max-w-5xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5">
                ...
                <article class="edu-legal-card reveal <?php if($i === 8): ?> is-wide <?php endif; ?> <?php if($i > 1): ?> s<?php echo e(min($i - 1, 3)); ?> <?php endif; ?>">
                    ...
                    <p class="text-slate-600 leading-relaxed text-sm sm:text-[0.9375rem]">
                        <?php echo nl2br(e($pub('legal_terms_s'.$i.'_body'))); ?>
    ...
    <div class="edu-container-full">
        <div class="edu-courses-inner max-w-4xl mx-auto reveal">
            <div class="text-center mb-8">
                <h2 class="text-xl font-extrabold text-slate-900"><?php echo e(__('public.legal_terms_related_title')); ?></h2>
                <p class="text-slate-600 text-sm mt-2"><?php echo e(__('public.legal_terms_related_sub')); ?></p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <a href="<?php echo e(route($link['route'])); ?>" class="edu-help-hub-card edu-card group">
                    <span class="edu-help-hub-icon group-hover:scale-105 transition-transform" style="background:linear-gradient(135deg,var(--edu-primary),var(--edu-purple))">
                        <i class="fas fa-<?php echo e($link['icon']); ?>"></i>
                    </span>
                    <span class="font-bold text-slate-900 text-sm"><?php echo e(__('public.'.$link['label'])); ?></span>
    ...
    <div class="edu-container-full">
        <div class="edu-courses-inner">
            <div class="edu-card p-8 sm:p-10 text-center max-w-3xl mx-auto reveal">
                ...
                <h2 class="edu-section-title text-slate-900 mb-3"><?php echo e(__('public.legal_cta_title')); ?></h2>
                <p class="text-slate-600 leading-8 mb-8 max-w-xl mx-auto"><?php echo e(__('public.legal_cta_desc')); ?></p>
