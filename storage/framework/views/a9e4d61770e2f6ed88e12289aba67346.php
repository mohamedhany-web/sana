...
<body x-data="{ showPassword: false, showPasswordConfirmation: false }">
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="flex-1 min-h-[240px] lg:min-h-screen bg-cover bg-center relative" style="background-image: url('<?php echo e($authBackgroundUrl ?? public_static_url('images/brainstorm-meeting.jpg')); ?>');">
