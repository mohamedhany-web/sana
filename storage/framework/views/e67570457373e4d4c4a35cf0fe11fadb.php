...
<a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-3 group <?php echo e($mb); ?>">
    ...
    <?php elseif($fallback === 'primary'): ?>
        <div class="<?php echo e($box); ?> rounded-xl flex items-center justify-center shadow-lg text-white font-black <?php echo e($mText); ?>" style="background:var(--edu-primary,<?php echo e(config('brand.colors.blue')); ?>)">
            <?php echo e(mb_substr(config('app.name', 'M'), 0, 1)); ?>
    ...
    <?php endif; ?>
    <span class="font-extrabold text-slate-800 <?php echo e($brandText); ?>"><?php echo e(config('app.name', 'Sana')); ?></span>
</a>
<?php /**PATH C:\xampp\htdocs\sana\resources\views\partials\auth-brand-link.blade.php ENDPATH**/ ?>