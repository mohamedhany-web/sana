...
<head>
    ...
    <title><?php echo e(__('tutor.apply_title')); ?> — <?php echo e($brand); ?></title>
...
<header class="ta-nav">
    <div class="edu-container flex items-center justify-between gap-4 py-3">
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2.5 font-extrabold text-slate-900 no-underline">
            <?php if($logoUrl): ?>
                <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($brand); ?>" class="w-9 h-9 rounded-xl object-contain">
            <?php endif; ?>
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?php echo e(route('staff.login')); ?>" class="text-sm font-bold text-[var(--edu-primary)] no-underline hover:underline">دخول المدربين</a>
        </div>
    </div>
</header>
...
<div class="ta-layout">
        ...
        <div class="ta-visual-inner relative z-10">
            <div class="ta-orbit">
                ...
                <div class="ta-main-photo">
                    <img src="<?php echo e($heroMain); ?>" alt="معلم سعودي — <?php echo e($brand); ?>" loading="eager">
                </div>
                <div class="ta-sub-photo ta-sub-photo--a">
                    <img src="<?php echo e($heroCircle); ?>" alt="معلّم أونلاين" loading="lazy">
                </div>
                <div class="ta-sub-photo ta-sub-photo--b">
                    <img src="<?php echo e($heroStudents); ?>" alt="طلاب يتعلمون" loading="lazy">
                </div>
            </div>
    ...
    <main class="ta-form-col">
        ...
        <form action="<?php echo e(route('tutor.apply.store')); ?>" method="POST" @submit="onSubmit" id="tutorApplyForm">
            <?php echo csrf_field(); ?>
            ...
            <div x-show="step === 1" x-cloak class="ix-step-panel" :key="'s1'">
                ...
                <p class="ta-lead mb-6 max-w-lg">
                    <?php echo e(__('tutor.apply_subtitle')); ?>
                ...
                <p class="text-sm text-slate-500 mt-6">
                    عندك حساب؟
                    <a href="<?php echo e(route('staff.login')); ?>" class="font-bold text-[var(--edu-primary)]">سجّل دخولك</a>
                </p>
            </div>
            ...
            <div x-show="step === 2" x-cloak class="ix-step-panel" :key="'s2'">
                ...
                <div class="space-y-4">
                    <div class="ix-field-wrap">
                        ...
                        <input type="text" name="name" x-model="name" class="ta-field" required autocomplete="name" value="<?php echo e(old('name')); ?>" @input="name = $event.target.value">
                        <i class="fas fa-circle-check ix-field-ok" x-show="name.trim().length >= 2" x-cloak></i>
                    </div>
                    <div class="ix-field-wrap">
                        <label class="ta-label">البريد الإلكتروني</label>
                        <input type="email" name="email" x-model="email" dir="ltr" class="ta-field" required autocomplete="email" value="<?php echo e(old('email')); ?>" @input="email = $event.target.value">
                    ...
                    <div>
                        ...
                        <div class="ta-phone">
                            <select name="country_code" x-model="countryCode" class="ta-field" dir="ltr">
                                ...
                                <option value="<?php echo e($c['dial_code']); ?>" <?php if(old('country_code', $defaultDialCode) === $c['dial_code']): echo 'selected'; endif; ?>><?php echo e($c['dial_code']); ?> <?php echo e($c['name_ar']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <input type="tel" name="phone" x-model="phone" dir="ltr" class="ta-field flex-1" inputmode="tel" placeholder="5xxxxxxxx" value="<?php echo e(old('phone')); ?>">
                        </div>
                    </div>
                    <div>
            ...
            <div x-show="step === 4" x-cloak class="ix-step-panel" :key="'s4'">
                ...
                <div class="space-y-4">
                    <div class="ix-field-wrap">
                        ...
                        <input type="text" name="headline" x-model="headline" class="ta-field" placeholder="مثال: معلّم رياضيات — ثانوي" required value="<?php echo e(old('headline')); ?>">
                    ...
                    <div class="ix-field-wrap">
                        ...
                        <textarea name="bio" x-model="bio" maxlength="500" class="ta-field ta-textarea" required><?php echo e(old('bio')); ?></textarea>
                        <i class="fas fa-circle-check ix-field-ok" x-show="bio.trim().length >= 20" x-cloak></i>
                    </div>
                    <div>
                        <label class="ta-label">سنوات الخبرة</label>
                        <input type="number" name="years_experience" x-model.number="yearsExp" class="ta-field" min="0" max="50" required value="<?php echo e(old('years_experience', 1)); ?>">
                    </div>
                </div>
                <div class="ta-actions">
            ...
            <div x-show="step === 6" x-cloak class="ix-step-panel" :key="'s6'">
                ...
                <div class="ta-check-grid mb-4" style="max-height:none">
                    <label class="ta-check-item ix-check-item"><input type="checkbox" name="matching_modes[]" value="pick_teacher" checked> <?php echo e(__('tutor.matching_pick_teacher')); ?></label>
                    <label class="ta-check-item ix-check-item"><input type="checkbox" name="matching_modes[]" value="self_schedule" checked> <?php echo e(__('tutor.matching_self_schedule')); ?></label>
                    <label class="ta-check-item ix-check-item"><input type="checkbox" name="matching_modes[]" value="assisted"> <?php echo e(__('tutor.matching_assisted')); ?></label>
                </div>
                <p class="ta-label">أنواع الحصص</p>
                <div class="ta-check-grid mb-4" style="max-height:none">
                    <label class="ta-check-item ix-check-item"><input type="checkbox" name="session_types[]" value="one_to_one" checked> <?php echo e(__('tutor.session_one_to_one')); ?></label>
                    <label class="ta-check-item ix-check-item"><input type="checkbox" name="session_types[]" value="small_group"> <?php echo e(__('tutor.session_small_group')); ?></label>
                </div>
...
<?php /**PATH C:\xampp\htdocs\sana\resources\views/tutor/apply.blade.php ENDPATH**/ ?>