            ...
            <div class="space-y-4">
                ...
                <dl class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between gap-4 border-b border-slate-100 pb-2">
                        ...
                        <dd class="font-medium <?php echo e($accountActive ? 'text-emerald-700' : 'text-amber-700'); ?>">
                            <?php echo e($accountActive ? 'نعم' : 'لا'); ?>
                    ...
                    <div class="flex justify-between gap-4 border-b border-slate-100 pb-2">
                        ...
                        <dd class="font-medium text-slate-900"><?php echo e($application->portalModeLabel()); ?></dd>
                    </div>
                    <?php endif; ?>
                </dl>
            </div>
