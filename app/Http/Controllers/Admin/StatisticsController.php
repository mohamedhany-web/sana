...
class StatisticsController extends Controller
{
    ...
    public function index()
    {
        ...
        $academicYearsStats->each(function($year) {
            ...
            abort(500, __('حدث خطأ أثناء تحميل الإحصائيات. يرجى المحاولة مرة أخرى.'));
        }
    }
    ...
    public function users()
    {
        ...
        try {
            ...
            abort(500, __('حدث خطأ أثناء تحميل إحصائيات المستخدمين. يرجى المحاولة مرة أخرى.'));
        }
    }
    ...
    public function courses()
    {
        ...
        try {
            ...
            abort(500, __('حدث خطأ أثناء تحميل إحصائيات الكورسات. يرجى المحاولة مرة أخرى.'));
        }
    }
}
