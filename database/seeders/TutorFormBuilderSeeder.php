...
class TutorFormBuilderSeeder extends Seeder
{
    ...
    private function systemFields(array $stepIds): array
    {
        return [
            ...
            ['step_id' => $stepIds['teaching'], 'field_key' => 'specializations_other', 'label' => 'تخصصات أخرى', 'field_type' => 'text', 'is_required' => true, 'width' => 'full', 'sort_order' => 2, 'settings' => ['max' => 200]],
            ...
            ['step_id' => $stepIds['video_docs'], 'field_key' => 'id_photo', 'label' => 'صورة هوية / إقامة', 'field_type' => 'file', 'is_required' => true, 'width' => 'full', 'sort_order' => 6, 'settings' => ['accept' => '.pdf,.jpg,.jpeg,.png', 'mimes' => 'jpg,jpeg,png,pdf']],
            ['step_id' => $stepIds['video_docs'], 'field_key' => 'experience_certs', 'label' => 'شهادات خبرة', 'field_type' => 'file', 'is_required' => true, 'width' => 'full', 'sort_order' => 7, 'settings' => ['accept' => '.pdf,.jpg,.jpeg,.png', 'mimes' => 'pdf,jpg,jpeg,png']],
            ['step_id' => $stepIds['video_docs'], 'field_key' => 'training_certs', 'label' => 'شهادات تدريبية', 'field_type' => 'file', 'is_required' => true, 'width' => 'full', 'sort_order' => 8, 'settings' => ['accept' => '.pdf,.jpg,.jpeg,.png', 'mimes' => 'pdf,jpg,jpeg,png']],
            ['step_id' => $stepIds['video_docs'], 'field_key' => 'portfolio_file', 'label' => 'نماذج أعمال', 'field_type' => 'file', 'is_required' => true, 'width' => 'full', 'sort_order' => 9, 'settings' => ['accept' => '.pdf,.jpg,.jpeg,.png,.ppt,.pptx', 'mimes' => 'pdf,jpg,jpeg,png,ppt,pptx']],
